...
## Pleya Server (goedgekeurde baseline, PS-2 vrijgegeven)
...
Twee poorten staan nog open en horen dicht vóór PS-4: het conflictmodel voor kijkstatus, en de
byte-validator achter de `ETag`-belofte (waaronder de regel voor de content fingerprint, vóór
scannerlogica die relocatie gebruikt). De stand van alle vier staat in
