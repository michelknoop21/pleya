...
// Permission is één trede van de ladder uit DEC-065 §4: view < download <
...
// nodig heeft (DEC-065 §2): owner en admin volgen uit de rol zelf, want
...
// dit is autorisatiebeleid over catalogusresources (DEC-065 §2), niet
...
// MayAccess zegt of userID libraryID minimaal met need mag benaderen (DEC-065,
// DEC-072). Dit is DE controle uit AC2: een bibliotheek die de aanvrager niet
...
// vóór een kijkstatusevent wordt toegepast (AC2, PS-9, DEC-072 regel 12) —
