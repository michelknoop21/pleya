...
// Stap 6 van de PS-9-implementatievolgorde: de sessie-endpoints uit DEC-070,
// matrixregel 15, en de gemeten bovengrens van twee seconden uit DEC-066.
//
...
// TestSessionListMarksTheCurrentOne dekt de inzage uit DEC-070.
...
func TestSessionScopeIsMatrixRule15(t *testing.T) {
	...
	// device-scoped intrekking (DEC-069).
...
// DELETE /sessions/{id} uit DEC-070: het eerste is "log mij hier uit" en
...
// TestRevokedSessionKillsEveryCredential is de symmetrie die DEC-066 eist: het
...
// gemeten en niet booleaans afgevinkt (DEC-066).
//
...
func TestRevocationStopsRunningStreamWithinTwoSeconds(t *testing.T) {
	...
	// Intrekken. De grens uit DEC-066 gaat over de server: hoe lang blijft hij
	...
	if latency > 2*time.Second {
		t.Fatalf("de server stopte pas %s na de intrekking; DEC-066 legt de bovengrens op twee seconden", latency)
	}
...
// TestRevocationRegisterSurvivesRestart dekt de laadstap uit DEC-066: zonder
