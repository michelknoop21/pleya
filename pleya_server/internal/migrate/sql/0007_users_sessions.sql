...
--
-- Volgt DEC-065 (rollen en rechten), DEC-069 (sessie- en tokenketen) en
-- DEC-071 (migratie van bestaande refreshketens). Specificatie 6.5 zei dat een
...
COMMENT ON TABLE users IS
    'Vier rollen (DEC-065): owner precies een, admin/member/restricted nul of meer.';

-- 2. Sessies. Een toestel, niet een gebruiker (DEC-069): sid loopt door de
...
-- booleans (DEC-065): view < download < manage, per constructie in plaats van
...
BEGIN
    IF NEW.permission = 'manage' AND EXISTS (
        ...
        RAISE EXCEPTION 'restricted mag geen manage krijgen (DEC-065)'
...
-- browserstreamsessies meeneemt (DEC-069). Nullable: een bestaande rij (op de
...
-- 6. Legacy-sessies voor bestaande actieve refreshketens (DEC-071). Een sessie
