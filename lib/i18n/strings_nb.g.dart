...
class _TranslationsSearchNb extends TranslationsSearchEn {
	...
	@override String get notOnYourServers => 'Ikke på serverne dine';
...
class _TranslationsUnifiedCatalogFiltersNb extends TranslationsUnifiedCatalogFiltersEn {
	...
	@override String activeCount({required Object count}) => '${count} aktive';
...
extension on TranslationsNb {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'search.notOnYourServers' => 'Ikke på serverne dine',
			...
			'unifiedCatalog.filters.activeCount' => ({required Object count}) => '${count} aktive',
