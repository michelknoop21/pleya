...
class TranslationsNb extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsMobileDetailNb mobileDetail = _TranslationsMobileDetailNb._(_root);
...
class _TranslationsSettingsNb extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Støtt Pleya';
	...
	@override String get importSettingsInvalidFile => 'Denne filen er ikke en gyldig Pleya-innstillingseksport';
	...
	@override String get startInFullscreenDescription => 'Åpne Pleya i fullskjermmodus ved oppstart';
	...
	@override String get startupSectionDescription => 'Velg hvilken seksjon Pleya åpner ved oppstart';
...
class _TranslationsSearchNb extends TranslationsSearchEn {
	...
	@override late final _TranslationsSearchFiltersNb filters = _TranslationsSearchFiltersNb._(_root);
}
...
class _TranslationsMessagesNb extends TranslationsMessagesEn {
	...
	@override String get errorLoading => 'Feil';
	@override String get fileInfoNotAvailable => 'Filinformasjon ikke tilgjengelig';
	@override String get errorLoadingFileInfo => 'Feil ved lasting av filinformasjon';
	...
	@override String get libraryScanFailed => 'Kunne ikke skanne bibliotek';
	...
	@override String get metadataRefreshFailed => 'Kunne ikke oppdatere metadata';
...
class _TranslationsProfilesNb extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPleyaProfile => 'Legg til Pleya-profil';
...
class _TranslationsDiscoverNb extends TranslationsDiscoverEn {
	...
	@override String get recentlyReleased => 'Nylig utgitt';
...
// Path: mobileDetail
class _TranslationsMobileDetailNb extends TranslationsMobileDetailEn {
	_TranslationsMobileDetailNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsErrorsNb extends TranslationsErrorsEn {
	...
	// Translations
	@override String get searchFailed => 'Søk mislyktes';
	...
	@override String failedToLoad({required Object context}) => 'Kunne ikke laste ${context}';
	...
	@override String get failedToVerifyToken => 'Kunne ikke verifisere token';
...
class _TranslationsServerSelectionNb extends TranslationsServerSelectionEn {
	...
	@override String get failedToLoadServers => 'Kunne ikke laste servere';
}
...
class _TranslationsCollectionsNb extends TranslationsCollectionsEn {
	...
	@override String get failedToLoadItems => 'Kunne ikke laste samlingselementer';
	...
	@override String get removeFromCollectionError => 'Feil ved fjerning fra samling';
...
class _TranslationsTraktNb extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Pleya slutter å sende hendelser til Trakt. Du kan koble til igjen når som helst.';
	...
	@override String get watchedSyncDescription => 'Når du markerer noe som sett i Pleya, markeres det også på Trakt.';
}
...
class _TranslationsTrackersNb extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleya slutter å oppdatere ${service}. Koble til igjen når som helst.';
...
class _TranslationsAddServerNb extends TranslationsAddServerEn {
	...
	@override String get signInFailed => 'Pålogging mislyktes';
	@override String get quickConnectFailed => 'Quick Connect mislyktes';
...
// Path: addLocalFolder
class _TranslationsAddLocalFolderNb extends TranslationsAddLocalFolderEn {
	_TranslationsAddLocalFolderNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: pleyaShare
class _TranslationsPleyaShareNb extends TranslationsPleyaShareEn {
	_TranslationsPleyaShareNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get cardTitle => 'Pleya Share';
	@override String get cardSubtitle => 'Koble til en annen Pleya-enhet som deler mediene sine';
	@override String get hostTitle => 'Del mediene mine';
	@override String get hostDescription => 'Andre Pleya-enheter på dette nettverket kan bla i, strømme og laste ned de lokale mappene dine. Hold denne skjermen åpen mens du deler.';
	@override String get hostToggle => 'Del lokale mapper';
	@override String get noLocalFolders => 'Legg først til en lokal mappe — det er ingenting å dele ennå.';
	@override String get pairCodeLabel => 'Paringskode';
	@override String get pairCodeHint => 'Skriv inn denne koden på den andre enheten. Koden endres etter hver vellykkede paring.';
	@override String get regenerateCode => 'Ny kode';
	@override String get pairedDevices => 'Parede enheter';
	@override String get noGuests => 'Ingen enheter paret ennå';
	@override String get revokeGuest => 'Fjern enhet';
	@override String get joinTitle => 'Koble til Pleya Share';
	@override String get joinDescription => 'Velg en vert funnet på nettverket eller skriv inn adressen, og tast deretter den 6-sifrede koden som vises på den enheten.';
	@override String get hostsFound => 'Verter på nettverket ditt';
	@override String get searching => 'Søker etter verter…';
	@override String get noHostsFound => 'Ingen verter funnet. Sjekk at deling er på og at begge enhetene er på samme nettverk.';
	@override String get refresh => 'Søk på nytt';
	@override String get manualHost => 'Vertsadresse (IP)';
	@override String get codeLabel => '6-sifret kode';
	@override String get connect => 'Koble til';
	@override String get pairFailed => 'Paring mislyktes. Sjekk koden og prøv igjen.';
	@override String paired({required Object name}) => 'Koblet til ${name}';
	@override String get pairUnreachable => 'Verten er ikke tilgjengelig. Sjekk adressen og nettverket.';
	@override String get addFolder => 'Legg til lokal mappe';
	@override String get notificationTitle => 'Deler medier';
	@override String get notificationText => 'Andre Pleya-enheter kan strømme de lokale mappene dine';
	@override String get hostDescriptionAndroid => 'Andre Pleya-enheter på dette nettverket kan bla i, strømme og laste ned de lokale mappene dine. Delingen fortsetter i bakgrunnen med et varsel.';
...
// Path: unifiedCatalog
class _TranslationsUnifiedCatalogNb extends TranslationsUnifiedCatalogEn {
	_TranslationsUnifiedCatalogNb._(TranslationsNb root) : this._root = root, super.internal(root);
	...
	@override String get loadMore => 'Last inn flere';
	@override String get loadingMore => 'Laster flere…';
	@override late final _TranslationsUnifiedCatalogSortNb sort = _TranslationsUnifiedCatalogSortNb._(_root);
	@override late final _TranslationsUnifiedCatalogFiltersNb filters = _TranslationsUnifiedCatalogFiltersNb._(_root);
...
// Path: tvNavigation
class _TranslationsTvNavigationNb extends TranslationsTvNavigationEn {
	_TranslationsTvNavigationNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: tvMyPleya
class _TranslationsTvMyPleyaNb extends TranslationsTvMyPleyaEn {
	_TranslationsTvMyPleyaNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get groupContent => 'Mitt innhold';
	@override String get groupSources => 'Biblioteker og kilder';
	@override String get groupPleya => 'Pleya';
	@override String serversOnline({required Object online, required Object total}) => '${online} av ${total} servere tilkoblet';
	@override String get noServers => 'Ingen servere tilkoblet';
	@override String get statusOnline => 'Tilkoblet';
	@override String get statusOffline => 'Frakoblet';
	@override String get servers => 'Servere';
	@override String get activity => 'Aktivitet';
	@override String get logs => 'Logger og diagnostikk';
	@override String signedInAs({required Object name, required Object version}) => 'Logget inn som ${name} · Pleya ${version}';
	@override String get watchlistSubtitle => 'Lagrede filmer og serier';
	@override String get requestsSubtitle => 'Forespørsler og oppdagelse';
	@override String get downloadsSubtitle => 'Frakoblet og synkroniseringsregler';
	...
	@override String get activitySubtitle => 'Ser nå';
...
// Path: search.filters
class _TranslationsSearchFiltersNb extends TranslationsSearchFiltersEn {
	_TranslationsSearchFiltersNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsVideoControlsPipErrorsNb extends TranslationsVideoControlsPipErrorsEn {
	...
	@override String get unknown => 'En feil oppstod';
}
...
class _TranslationsCompanionRemotePairingNb extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Pleya-enheter med samme Plex-konto vises her';
	...
	@override String get noDevicesHint => 'Åpne Pleya på desktop og bruk samme WiFi';
	...
	@override String get sessionNotFound => 'Enhet ikke funnet. Sørg for at Pleya kjører på verten.';
	@override String get authFailed => 'Autentisering mislyktes. Begge enheter må bruke samme Plex-konto.';
	@override String get failedToConnect => 'Kunne ikke koble til';
}
...
class _TranslationsTrackersDeviceCodeNb extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Aktiver Pleya på ${service}';
...
class _TranslationsUnifiedCatalogSortNb extends TranslationsUnifiedCatalogSortEn {
	_TranslationsUnifiedCatalogSortNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get title => 'Sorter';
	@override String get titleAsc => 'Tittel A–Å';
	@override String get titleDesc => 'Tittel Å–A';
	@override String get recentlyAdded => 'Nylig lagt til';
	@override String get oldestAdded => 'Først lagt til';
	@override String get newestRelease => 'Nyeste utgivelse';
	@override String get oldestRelease => 'Eldste utgivelse';
	@override String get recentlyWatched => 'Nylig sett';
}

// Path: unifiedCatalog.filters
class _TranslationsUnifiedCatalogFiltersNb extends TranslationsUnifiedCatalogFiltersEn {
	_TranslationsUnifiedCatalogFiltersNb._(TranslationsNb root) : this._root = root, super.internal(root);
	...
	@override String get clearAll => 'Tøm alt';
	@override String get all => 'Alle';
...
class _TranslationsUnifiedCatalogStatesNb extends TranslationsUnifiedCatalogStatesEn {
	_TranslationsUnifiedCatalogStatesNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get emptyTitle => 'Denne katalogen er tom';
	@override String get emptyBody => 'Ingen synlig bibliotek inneholder noe for denne siden.';
	@override String get filterEmptyTitle => 'Ingenting samsvarer med disse filtrene';
	@override String get filterEmptyBody => 'Tøm et filter for å se flere titler.';
	@override String get clearFilters => 'Tøm filtre';
	@override String get errorTitle => 'Katalogen kunne ikke lastes';
	@override String get errorBody => 'Ingen server svarte. Sjekk tilkoblingen og prøv igjen.';
	@override String get partialOne => '1 bibliotek svarte ikke';
	@override String partialMany({required Object count}) => '${count} biblioteker svarte ikke';
}

// Path: unifiedCatalog.semantics
class _TranslationsUnifiedCatalogSemanticsNb extends TranslationsUnifiedCatalogSemanticsEn {
	_TranslationsUnifiedCatalogSemanticsNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get watched => 'Sett';
	@override String get inProgress => 'Påbegynt';
	@override String get loadingMore => 'Laster flere titler';
}

// Path: unifiedCatalog.discovery
class _TranslationsUnifiedCatalogDiscoveryNb extends TranslationsUnifiedCatalogDiscoveryEn {
	_TranslationsUnifiedCatalogDiscoveryNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get allMovies => 'Alle filmer';
	...
	@override String get partial => 'Noen kilder svarte ikke';
...
class _TranslationsTvMyPleyaSemanticsNb extends TranslationsTvMyPleyaSemanticsEn {
	_TranslationsTvMyPleyaSemanticsNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsUnifiedCatalogDiscoverySemanticsNb extends TranslationsUnifiedCatalogDiscoverySemanticsEn {
	_TranslationsUnifiedCatalogDiscoverySemanticsNb._(TranslationsNb root) : this._root = root, super.internal(root);
	...
	@override String get viewAllMovies => 'Se alle filmer, åpner den komplette katalogen';
	@override String get viewAllSeries => 'Se alle serier, åpner den komplette katalogen';
}
...
extension on TranslationsNb {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Støtt Pleya',
			...
			'settings.importSettingsInvalidFile' => 'Denne filen er ikke en gyldig Pleya-innstillingseksport',
			...
			'settings.startInFullscreenDescription' => 'Åpne Pleya i fullskjermmodus ved oppstart',
			...
			'settings.startupSectionDescription' => 'Velg hvilken seksjon Pleya åpner ved oppstart',
			...
			'videoControls.pipErrors.unknown' => 'En feil oppstod',
			...
			'messages.errorLoading' => 'Feil',
			'messages.fileInfoNotAvailable' => 'Filinformasjon ikke tilgjengelig',
			'messages.errorLoadingFileInfo' => 'Feil ved lasting av filinformasjon',
			...
			'messages.libraryScanFailed' => 'Kunne ikke skanne bibliotek',
			...
			'messages.metadataRefreshFailed' => 'Kunne ikke oppdatere metadata',
			...
			'profiles.addPleyaProfile' => 'Legg til Pleya-profil',
			...
			'discover.recentlyReleased' => 'Nylig utgitt',
			...
			'errors.searchFailed' => 'Søk mislyktes',
			...
			'errors.failedToLoad' => ({required Object context}) => 'Kunne ikke laste ${context}',
			'errors.noClientAvailable' => 'Ingen klient tilgjengelig',
			'errors.authenticationFailed' => 'Autentisering mislyktes',
			...
			'errors.failedToVerifyToken' => 'Kunne ikke verifisere token',
			...
			'serverSelection.failedToLoadServers' => 'Kunne ikke laste servere',
			...
			'collections.failedToLoadItems' => 'Kunne ikke laste samlingselementer',
			...
			'collections.removeFromCollectionError' => 'Feil ved fjerning fra samling',
			...
			'companionRemote.pairing.failedToConnect' => 'Kunne ikke koble til',
			...
			'trakt.disconnectConfirmBody' => 'Pleya slutter å sende hendelser til Trakt. Du kan koble til igjen når som helst.',
			...
			'trakt.watchedSyncDescription' => 'Når du markerer noe som sett i Pleya, markeres det også på Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Pleya slutter å oppdatere ${service}. Koble til igjen når som helst.',
			'trackers.connectFailed' => ({required Object service}) => 'Kunne ikke koble til ${service}. Prøv igjen.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Aktiver Pleya på ${service}',
			...
			'addServer.signInFailed' => 'Pålogging mislyktes',
			'addServer.quickConnectFailed' => 'Quick Connect mislyktes',
			...
			'pleyaShare.cardSubtitle' => 'Koble til en annen Pleya-enhet som deler mediene sine',
			'pleyaShare.hostTitle' => 'Del mediene mine',
			'pleyaShare.hostDescription' => 'Andre Pleya-enheter på dette nettverket kan bla i, strømme og laste ned de lokale mappene dine. Hold denne skjermen åpen mens du deler.',
			'pleyaShare.hostToggle' => 'Del lokale mapper',
			'pleyaShare.noLocalFolders' => 'Legg først til en lokal mappe — det er ingenting å dele ennå.',
			'pleyaShare.pairCodeLabel' => 'Paringskode',
			'pleyaShare.pairCodeHint' => 'Skriv inn denne koden på den andre enheten. Koden endres etter hver vellykkede paring.',
			'pleyaShare.regenerateCode' => 'Ny kode',
			'pleyaShare.pairedDevices' => 'Parede enheter',
			'pleyaShare.noGuests' => 'Ingen enheter paret ennå',
			'pleyaShare.revokeGuest' => 'Fjern enhet',
			'pleyaShare.joinTitle' => 'Koble til Pleya Share',
			'pleyaShare.joinDescription' => 'Velg en vert funnet på nettverket eller skriv inn adressen, og tast deretter den 6-sifrede koden som vises på den enheten.',
			'pleyaShare.hostsFound' => 'Verter på nettverket ditt',
			'pleyaShare.searching' => 'Søker etter verter…',
			'pleyaShare.noHostsFound' => 'Ingen verter funnet. Sjekk at deling er på og at begge enhetene er på samme nettverk.',
			'pleyaShare.refresh' => 'Søk på nytt',
			'pleyaShare.manualHost' => 'Vertsadresse (IP)',
			'pleyaShare.codeLabel' => '6-sifret kode',
			'pleyaShare.connect' => 'Koble til',
			'pleyaShare.pairFailed' => 'Paring mislyktes. Sjekk koden og prøv igjen.',
			'pleyaShare.paired' => ({required Object name}) => 'Koblet til ${name}',
			'pleyaShare.pairUnreachable' => 'Verten er ikke tilgjengelig. Sjekk adressen og nettverket.',
			'pleyaShare.addFolder' => 'Legg til lokal mappe',
			...
			'unifiedCatalog.loadMore' => 'Last inn flere',
			'unifiedCatalog.loadingMore' => 'Laster flere…',
			'unifiedCatalog.sort.title' => 'Sorter',
			'unifiedCatalog.sort.titleAsc' => 'Tittel A–Å',
			'unifiedCatalog.sort.titleDesc' => 'Tittel Å–A',
			'unifiedCatalog.sort.recentlyAdded' => 'Nylig lagt til',
			'unifiedCatalog.sort.oldestAdded' => 'Først lagt til',
			'unifiedCatalog.sort.newestRelease' => 'Nyeste utgivelse',
			'unifiedCatalog.sort.oldestRelease' => 'Eldste utgivelse',
			'unifiedCatalog.sort.recentlyWatched' => 'Nylig sett',
			'unifiedCatalog.filters.title' => 'Filtre',
			'unifiedCatalog.filters.status' => 'Status',
			'unifiedCatalog.filters.genre' => 'Sjanger',
			'unifiedCatalog.filters.year' => 'År',
			'unifiedCatalog.filters.servers' => 'Servere',
			'unifiedCatalog.filters.libraries' => 'Biblioteker',
			'unifiedCatalog.filters.apply' => 'Bruk',
			'unifiedCatalog.filters.clearAll' => 'Tøm alt',
			...
			'unifiedCatalog.states.filterEmptyTitle' => 'Ingenting samsvarer med disse filtrene',
			'unifiedCatalog.states.filterEmptyBody' => 'Tøm et filter for å se flere titler.',
			'unifiedCatalog.states.clearFilters' => 'Tøm filtre',
			'unifiedCatalog.states.errorTitle' => 'Katalogen kunne ikke lastes',
			'unifiedCatalog.states.errorBody' => 'Ingen server svarte. Sjekk tilkoblingen og prøv igjen.',
			'unifiedCatalog.states.partialOne' => '1 bibliotek svarte ikke',
			'unifiedCatalog.states.partialMany' => ({required Object count}) => '${count} biblioteker svarte ikke',
			'unifiedCatalog.semantics.watched' => 'Sett',
			'unifiedCatalog.semantics.inProgress' => 'Påbegynt',
			'unifiedCatalog.semantics.loadingMore' => 'Laster flere titler',
			'unifiedCatalog.discovery.allMovies' => 'Alle filmer',
			...
			'unifiedCatalog.discovery.partial' => 'Noen kilder svarte ikke',
			'unifiedCatalog.discovery.emptyTitle' => 'Ingenting å oppdage ennå',
			'unifiedCatalog.discovery.emptyBody' => 'Ingen synlige biblioteker har noe å vise her.',
			...
			'tvMyPleya.serversOnline' => ({required Object online, required Object total}) => '${online} av ${total} servere tilkoblet',
			'tvMyPleya.noServers' => 'Ingen servere tilkoblet',
			'tvMyPleya.statusOnline' => 'Tilkoblet',
			'tvMyPleya.statusOffline' => 'Frakoblet',
			'tvMyPleya.servers' => 'Servere',
			'tvMyPleya.activity' => 'Aktivitet',
			'tvMyPleya.logs' => 'Logger og diagnostikk',
			'tvMyPleya.signedInAs' => ({required Object name, required Object version}) => 'Logget inn som ${name} · Pleya ${version}',
			'tvMyPleya.watchlistSubtitle' => 'Lagrede filmer og serier',
			'tvMyPleya.requestsSubtitle' => 'Forespørsler og oppdagelse',
			'tvMyPleya.downloadsSubtitle' => 'Frakoblet og synkroniseringsregler',
			'tvMyPleya.librariesSubtitle' => 'Medier, samlinger, spillelister',
			'tvMyPleya.serversSubtitle' => 'Tilkoblinger og lokale kilder',
			'tvMyPleya.activitySubtitle' => 'Ser nå',
