...
class _TranslationsSettingsRu extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Поддержать PlexFlixNetwork';
	...
	@override String get importSettingsInvalidFile => 'Этот файл не является действительным экспортом настроек PlexFlixNetwork';
	...
	@override String get startInFullscreenDescription => 'Открывать PlexFlixNetwork в полноэкранном режиме при запуске';
	...
	@override String get startupSectionDescription => 'Выберите, какой раздел PlexFlixNetwork открывает при запуске';
...
class _TranslationsProfilesRu extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPlezyProfile => 'Добавить профиль PlexFlixNetwork';
...
class _TranslationsConnectionsRu extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Добавьте или удалите URL для ${serverName}. PlexFlixNetwork будет использовать доступный URL с минимальной задержкой.';
}
...
class _TranslationsTraktRu extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'PlexFlixNetwork перестанет отправлять события в Trakt. Можно подключить снова в любое время.';
	...
	@override String get watchedSyncDescription => 'Когда вы отмечаете элементы как просмотренные в PlexFlixNetwork, они отмечаются и в Trakt.';
}
...
class _TranslationsTrackersRu extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'PlexFlixNetwork перестанет обновлять ${service}. Подключите снова в любое время.';
...
class _TranslationsCompanionRemotePairingRu extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Устройства PlexFlixNetwork с тем же аккаунтом Plex появятся здесь';
	...
	@override String get noDevicesHint => 'Откройте PlexFlixNetwork на компьютере и используйте тот же WiFi';
	...
	@override String get sessionNotFound => 'Устройство не найдено. Убедитесь, что PlexFlixNetwork запущен на хосте.';
...
class _TranslationsTrackersDeviceCodeRu extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Активируйте PlexFlixNetwork в ${service}';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Поддержать PlexFlixNetwork',
			...
			'settings.importSettingsInvalidFile' => 'Этот файл не является действительным экспортом настроек PlexFlixNetwork',
			...
			'settings.startInFullscreenDescription' => 'Открывать PlexFlixNetwork в полноэкранном режиме при запуске',
			...
			'settings.startupSectionDescription' => 'Выберите, какой раздел PlexFlixNetwork открывает при запуске',
			...
			'profiles.addPlezyProfile' => 'Добавить профиль PlexFlixNetwork',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Добавьте или удалите URL для ${serverName}. PlexFlixNetwork будет использовать доступный URL с минимальной задержкой.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Устройства PlexFlixNetwork с тем же аккаунтом Plex появятся здесь',
			...
			'companionRemote.pairing.noDevicesHint' => 'Откройте PlexFlixNetwork на компьютере и используйте тот же WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Устройство не найдено. Убедитесь, что PlexFlixNetwork запущен на хосте.',
			...
			'trakt.disconnectConfirmBody' => 'PlexFlixNetwork перестанет отправлять события в Trakt. Можно подключить снова в любое время.',
			...
			'trakt.watchedSyncDescription' => 'Когда вы отмечаете элементы как просмотренные в PlexFlixNetwork, они отмечаются и в Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'PlexFlixNetwork перестанет обновлять ${service}. Подключите снова в любое время.',
			'trackers.connectFailed' => ({required Object service}) => 'Не удалось подключиться к ${service}. Попробуйте ещё раз.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Активируйте PlexFlixNetwork в ${service}',
