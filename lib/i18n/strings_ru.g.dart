...
class _TranslationsSettingsRu extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Поддержать Pleya';
	...
	@override String get importSettingsInvalidFile => 'Этот файл не является действительным экспортом настроек Pleya';
	...
	@override String get startInFullscreenDescription => 'Открывать Pleya в полноэкранном режиме при запуске';
	...
	@override String get startupSectionDescription => 'Выберите, какой раздел Pleya открывает при запуске';
...
class _TranslationsMessagesRu extends TranslationsMessagesEn {
	...
	@override String get errorLoading => 'Ошибка';
	@override String get fileInfoNotAvailable => 'Информация о файле недоступна';
	@override String get errorLoadingFileInfo => 'Ошибка загрузки информации о файле';
	...
	@override String get libraryScanFailed => 'Не удалось отсканировать библиотеку';
	...
	@override String get metadataRefreshFailed => 'Не удалось обновить метаданные';
	...
	@override String failedPlayback({required Object action}) => 'Не удалось ${action}';
...
class _TranslationsDiscoverRu extends TranslationsDiscoverEn {
	...
	@override String get recentlyReleased => 'Недавно вышедшие';
...
class _TranslationsErrorsRu extends TranslationsErrorsEn {
	...
	// Translations
	@override String get searchFailed => 'Ошибка поиска';
	...
	@override String failedToLoad({required Object context}) => 'Не удалось загрузить ${context}';
	...
	@override String get failedToVerifyToken => 'Не удалось проверить токен';
...
class _TranslationsLibrariesRu extends TranslationsLibrariesEn {
	...
	@override String get failedToEmptyTrash => 'Не удалось очистить корзину';
	...
	@override String get failedToAnalyze => 'Не удалось проанализировать библиотеку';
...
class _TranslationsServerSelectionRu extends TranslationsServerSelectionEn {
	...
	@override String get failedToLoadServers => 'Не удалось загрузить серверы';
}
...
class _TranslationsCollectionsRu extends TranslationsCollectionsEn {
	...
	@override String get deleteFailedWithError => 'Не удалось удалить коллекцию';
	@override String get failedToLoadItems => 'Не удалось загрузить элементы коллекции';
	...
	@override String get removeFromCollectionError => 'Ошибка удаления из коллекции';
...
class _TranslationsTraktRu extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Pleya перестанет отправлять события в Trakt. Можно подключить снова в любое время.';
	...
	@override String get watchedSyncDescription => 'Когда вы отмечаете элементы как просмотренные в Pleya, они отмечаются и в Trakt.';
}
...
class _TranslationsTrackersRu extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleya перестанет обновлять ${service}. Подключите снова в любое время.';
...
class _TranslationsAddServerRu extends TranslationsAddServerEn {
	...
	@override String get couldNotReachServer => 'Не удалось связаться с сервером';
	@override String get signInFailed => 'Не удалось войти';
	@override String get quickConnectFailed => 'Quick Connect не удался';
...
// Path: addLocalFolder
class _TranslationsAddLocalFolderRu extends TranslationsAddLocalFolderEn {
	_TranslationsAddLocalFolderRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsVideoControlsPipErrorsRu extends TranslationsVideoControlsPipErrorsEn {
	...
	@override String get unknown => 'Произошла ошибка';
}
...
class _TranslationsCompanionRemotePairingRu extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Устройства Pleya с тем же аккаунтом Plex появятся здесь';
	...
	@override String get noDevicesHint => 'Откройте Pleya на компьютере и используйте тот же WiFi';
	...
	@override String get sessionNotFound => 'Устройство не найдено. Убедитесь, что Pleya запущен на хосте.';
	@override String get authFailed => 'Аутентификация не удалась. На обоих устройствах нужен один аккаунт Plex.';
	@override String get failedToConnect => 'Не удалось подключиться';
}
...
class _TranslationsTrackersDeviceCodeRu extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Активируйте Pleya в ${service}';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Поддержать Pleya',
			...
			'settings.importSettingsInvalidFile' => 'Этот файл не является действительным экспортом настроек Pleya',
			...
			'settings.startInFullscreenDescription' => 'Открывать Pleya в полноэкранном режиме при запуске',
			...
			'settings.startupSectionDescription' => 'Выберите, какой раздел Pleya открывает при запуске',
			...
			'videoControls.pipErrors.unknown' => 'Произошла ошибка',
			...
			'messages.errorLoading' => 'Ошибка',
			'messages.fileInfoNotAvailable' => 'Информация о файле недоступна',
			'messages.errorLoadingFileInfo' => 'Ошибка загрузки информации о файле',
			...
			'messages.libraryScanFailed' => 'Не удалось отсканировать библиотеку',
			...
			'messages.metadataRefreshFailed' => 'Не удалось обновить метаданные',
			...
			'discover.recentlyReleased' => 'Недавно вышедшие',
			...
			'errors.failedToLoad' => ({required Object context}) => 'Не удалось загрузить ${context}',
			'errors.noClientAvailable' => 'Клиент недоступен',
			'errors.authenticationFailed' => 'Ошибка аутентификации',
			...
			'errors.failedToVerifyToken' => 'Не удалось проверить токен',
			...
			'libraries.failedToEmptyTrash' => 'Не удалось очистить корзину',
			...
			'libraries.failedToAnalyze' => 'Не удалось проанализировать библиотеку',
			...
			'serverSelection.failedToLoadServers' => 'Не удалось загрузить серверы',
			...
			'collections.deleteFailedWithError' => 'Не удалось удалить коллекцию',
			'collections.failedToLoadItems' => 'Не удалось загрузить элементы коллекции',
			...
			'collections.removeFromCollectionError' => 'Ошибка удаления из коллекции',
			...
			'companionRemote.pairing.failedToConnect' => 'Не удалось подключиться',
			...
			'trakt.disconnectConfirmBody' => 'Pleya перестанет отправлять события в Trakt. Можно подключить снова в любое время.',
			...
			'trakt.watchedSyncDescription' => 'Когда вы отмечаете элементы как просмотренные в Pleya, они отмечаются и в Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Pleya перестанет обновлять ${service}. Подключите снова в любое время.',
			'trackers.connectFailed' => ({required Object service}) => 'Не удалось подключиться к ${service}. Попробуйте ещё раз.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Активируйте Pleya в ${service}',
			...
			'addServer.couldNotReachServer' => 'Не удалось связаться с сервером',
			'addServer.signInFailed' => 'Не удалось войти',
			'addServer.quickConnectFailed' => 'Quick Connect не удался',
