...
class _TranslationsSettingsDa extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Støt Pleya';
	...
	@override String get importSettingsInvalidFile => 'Denne fil er ikke en gyldig Pleya-indstillingseksport';
	...
	@override String get startInFullscreenDescription => 'Åbn Pleya i fuldskærmstilstand ved opstart';
	...
	@override String get startupSectionDescription => 'Vælg hvilken sektion Pleya åbner ved start';
...
class _TranslationsDiscoverDa extends TranslationsDiscoverEn {
	...
	@override String get recentlyReleased => 'Nyligt udgivet';
...
class _TranslationsTraktDa extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Pleya stopper med at sende hændelser til Trakt. Du kan tilslutte igen når som helst.';
	...
	@override String get watchedSyncDescription => 'Når du markerer ting som sét i Pleya, markeres de også på Trakt.';
}
...
class _TranslationsTrackersDa extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleya stopper med at opdatere ${service}. Tilslut igen når som helst.';
...
// Path: addLocalFolder
class _TranslationsAddLocalFolderDa extends TranslationsAddLocalFolderEn {
	_TranslationsAddLocalFolderDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsCompanionRemotePairingDa extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Pleya-enheder med samme Plex-konto vises her';
	...
	@override String get noDevicesHint => 'Åbn Pleya på desktop, og brug samme WiFi';
...
extension on TranslationsDa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Støt Pleya',
			...
			'settings.importSettingsInvalidFile' => 'Denne fil er ikke en gyldig Pleya-indstillingseksport',
			...
			'settings.startInFullscreenDescription' => 'Åbn Pleya i fuldskærmstilstand ved opstart',
			...
			'settings.startupSectionDescription' => 'Vælg hvilken sektion Pleya åbner ved start',
			...
			'discover.recentlyReleased' => 'Nyligt udgivet',
			...
			'trakt.disconnectConfirmBody' => 'Pleya stopper med at sende hændelser til Trakt. Du kan tilslutte igen når som helst.',
			...
			'trakt.watchedSyncDescription' => 'Når du markerer ting som sét i Pleya, markeres de også på Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Pleya stopper med at opdatere ${service}. Tilslut igen når som helst.',
