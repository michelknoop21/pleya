...
class _TranslationsSettingsJa extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Pleya を支援';
	...
	@override String get importSettingsInvalidFile => 'このファイルは有効なPleyaの設定エクスポートではありません';
	...
	@override String get startInFullscreenDescription => '起動時にPleyaを全画面モードで開きます';
	...
	@override String get startupSectionDescription => '起動時に Pleya が開くセクションを選択します';
...
class _TranslationsProfilesJa extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPleyaProfile => 'Pleyaプロファイルを追加';
...
class _TranslationsTraktJa extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'PleyaはTraktへのイベント送信を停止します。いつでも再接続できます。';
	...
	@override String get watchedSyncDescription => 'Pleya で項目を視聴済みにすると、Trakt でも視聴済みになります。';
}
...
class _TranslationsTrackersJa extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleyaは${service}の更新を停止します。いつでも再接続できます。';
...
// Path: addLocalFolder
class _TranslationsAddLocalFolderJa extends TranslationsAddLocalFolderEn {
	_TranslationsAddLocalFolderJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsTvMyPleyaJa extends TranslationsTvMyPleyaEn {
	...
	@override String get activitySubtitle => '再生中';
...
class _TranslationsCompanionRemotePairingJa extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => '同じPlexアカウントのPleyaデバイスがここに表示されます';
	...
	@override String get noDevicesHint => 'デスクトップでPleyaを開き、同じWiFiを使用してください';
...
class _TranslationsTrackersDeviceCodeJa extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => '${service} で Pleya を有効化';
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.title' => '設定',
			'settings.supportDeveloper' => 'Pleya を支援',
			...
			'settings.importSettingsInvalidFile' => 'このファイルは有効なPleyaの設定エクスポートではありません',
			...
			'settings.startInFullscreenDescription' => '起動時にPleyaを全画面モードで開きます',
			...
			'settings.startupSectionDescription' => '起動時に Pleya が開くセクションを選択します',
			...
			'profiles.addPleyaProfile' => 'Pleyaプロファイルを追加',
			...
			'trakt.disconnectConfirmBody' => 'PleyaはTraktへのイベント送信を停止します。いつでも再接続できます。',
			'trakt.scrobble' => 'リアルタイムのスクロブル',
			'trakt.scrobbleDescription' => '再生中に再生・一時停止・停止イベントを Trakt に送信します。',
			'trakt.watchedSync' => '視聴済みステータスを同期',
			'trakt.watchedSyncDescription' => 'Pleya で項目を視聴済みにすると、Trakt でも視聴済みになります。',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Pleyaは${service}の更新を停止します。いつでも再接続できます。',
			'trackers.connectFailed' => ({required Object service}) => '${service} に接続できませんでした。もう一度お試しください。',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => '${service} で Pleya を有効化',
			...
			'tvMyPleya.activitySubtitle' => '再生中',
