...
class _TranslationsSettingsSv extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Stöd PlexFlixNetwork';
	...
	@override String get importSettingsInvalidFile => 'Denna fil är inte en giltig PlexFlixNetwork-export';
	...
	@override String get startInFullscreenDescription => 'Öppna PlexFlixNetwork i helskärm vid start';
	...
	@override String get startupSectionDescription => 'Välj vilken sektion PlexFlixNetwork öppnar vid start';
...
class _TranslationsProfilesSv extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPlezyProfile => 'Lägg till PlexFlixNetwork-profil';
...
class _TranslationsConnectionsSv extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Lägg till eller ta bort URL:er för ${serverName}. PlexFlixNetwork använder den nåbara URL:en med lägst latens.';
}
...
class _TranslationsTraktSv extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'PlexFlixNetwork slutar skicka händelser till Trakt. Du kan återansluta när som helst.';
	...
	@override String get watchedSyncDescription => 'När du markerar något som tittat i PlexFlixNetwork markeras det också på Trakt.';
}
...
class _TranslationsTrackersSv extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'PlexFlixNetwork slutar uppdatera ${service}. Återanslut när som helst.';
...
class _TranslationsCompanionRemotePairingSv extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'PlexFlixNetwork-enheter med samma Plex-konto visas här';
	...
	@override String get noDevicesHint => 'Öppna PlexFlixNetwork på desktop och använd samma WiFi';
	...
	@override String get sessionNotFound => 'Enhet hittades inte. Kontrollera att PlexFlixNetwork körs på värden.';
...
class _TranslationsTrackersDeviceCodeSv extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Aktivera PlexFlixNetwork på ${service}';
...
extension on TranslationsSv {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Stöd PlexFlixNetwork',
			...
			'settings.importSettingsInvalidFile' => 'Denna fil är inte en giltig PlexFlixNetwork-export',
			...
			'settings.startInFullscreenDescription' => 'Öppna PlexFlixNetwork i helskärm vid start',
			...
			'settings.startupSectionDescription' => 'Välj vilken sektion PlexFlixNetwork öppnar vid start',
			...
			'profiles.addPlezyProfile' => 'Lägg till PlexFlixNetwork-profil',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Lägg till eller ta bort URL:er för ${serverName}. PlexFlixNetwork använder den nåbara URL:en med lägst latens.',
			...
			'companionRemote.pairing.discoveryDescription' => 'PlexFlixNetwork-enheter med samma Plex-konto visas här',
			...
			'companionRemote.pairing.noDevicesHint' => 'Öppna PlexFlixNetwork på desktop och använd samma WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Enhet hittades inte. Kontrollera att PlexFlixNetwork körs på värden.',
			...
			'trakt.disconnectConfirmBody' => 'PlexFlixNetwork slutar skicka händelser till Trakt. Du kan återansluta när som helst.',
			...
			'trakt.watchedSyncDescription' => 'När du markerar något som tittat i PlexFlixNetwork markeras det också på Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'PlexFlixNetwork slutar uppdatera ${service}. Återanslut när som helst.',
			'trackers.connectFailed' => ({required Object service}) => 'Kunde inte ansluta till ${service}. Försök igen.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Aktivera PlexFlixNetwork på ${service}',
