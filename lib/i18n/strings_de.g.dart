...
class _TranslationsSearchDe extends TranslationsSearchEn {
	...
	@override String get notOnYourServers => 'Nicht auf deinen Servern';
...
class _TranslationsTvMyPleyaDe extends TranslationsTvMyPleyaEn {
	...
	@override String get activitySubtitle => 'Läuft gerade, gemeinsam ansehen, Remote';
...
class _TranslationsUnifiedCatalogFiltersDe extends TranslationsUnifiedCatalogFiltersEn {
	...
	@override String get activeOne => '1 aktiv';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'search.notOnYourServers' => 'Nicht auf deinen Servern',
			...
			'unifiedCatalog.filters.activeCount' => ({required Object count}) => '${count} aktiv',
			'unifiedCatalog.filters.activeOne' => '1 aktiv',
			...
			'tvMyPleya.activitySubtitle' => 'Läuft gerade, gemeinsam ansehen, Remote',
