...
class TranslationsPt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsMobileDetailPt mobileDetail = _TranslationsMobileDetailPt._(_root);
...
// Path: mobileDetail
class _TranslationsMobileDetailPt extends TranslationsMobileDetailEn {
	_TranslationsMobileDetailPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsTvMyPleyaPt extends TranslationsTvMyPleyaEn {
	...
	@override String get activitySubtitle => 'A ver agora';
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'tvMyPleya.activitySubtitle' => 'A ver agora',
