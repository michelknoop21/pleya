...
class _TranslationsSettingsPt extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Apoie o PlexFlixNetwork';
	...
	@override String get importSettingsInvalidFile => 'Este arquivo não é uma exportação válida do PlexFlixNetwork';
	...
	@override String get startInFullscreenDescription => 'Abrir o PlexFlixNetwork em modo de tela cheia ao iniciar';
	...
	@override String get startupSectionDescription => 'Escolha qual seção o PlexFlixNetwork abre ao iniciar';
...
class _TranslationsProfilesPt extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPlezyProfile => 'Adicionar perfil PlexFlixNetwork';
...
class _TranslationsConnectionsPt extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Adicione ou remova URLs de ${serverName}. O PlexFlixNetwork usará a URL acessível com a menor latência.';
}
...
class _TranslationsTraktPt extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'PlexFlixNetwork deixará de enviar eventos ao Trakt. Você pode reconectar quando quiser.';
	...
	@override String get watchedSyncDescription => 'Ao marcar itens como assistidos no PlexFlixNetwork, eles também serão marcados no Trakt.';
}
...
class _TranslationsTrackersPt extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'PlexFlixNetwork deixará de atualizar ${service}. Reconecte quando quiser.';
...
class _TranslationsCompanionRemotePairingPt extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Dispositivos PlexFlixNetwork com a mesma conta Plex aparecem aqui';
	...
	@override String get noDevicesHint => 'Abra PlexFlixNetwork no desktop e use o mesmo WiFi';
	...
	@override String get sessionNotFound => 'Dispositivo não encontrado. Verifique se PlexFlixNetwork está rodando no host.';
...
class _TranslationsTrackersDeviceCodePt extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Ativar PlexFlixNetwork no ${service}';
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Apoie o PlexFlixNetwork',
			...
			'settings.importSettingsInvalidFile' => 'Este arquivo não é uma exportação válida do PlexFlixNetwork',
			...
			'settings.startInFullscreenDescription' => 'Abrir o PlexFlixNetwork em modo de tela cheia ao iniciar',
			...
			'settings.startupSectionDescription' => 'Escolha qual seção o PlexFlixNetwork abre ao iniciar',
			...
			'profiles.addPlezyProfile' => 'Adicionar perfil PlexFlixNetwork',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Adicione ou remova URLs de ${serverName}. O PlexFlixNetwork usará a URL acessível com a menor latência.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Dispositivos PlexFlixNetwork com a mesma conta Plex aparecem aqui',
			...
			'companionRemote.pairing.noDevicesHint' => 'Abra PlexFlixNetwork no desktop e use o mesmo WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Dispositivo não encontrado. Verifique se PlexFlixNetwork está rodando no host.',
			...
			'trakt.disconnectConfirmBody' => 'PlexFlixNetwork deixará de enviar eventos ao Trakt. Você pode reconectar quando quiser.',
			...
			'trakt.watchedSyncDescription' => 'Ao marcar itens como assistidos no PlexFlixNetwork, eles também serão marcados no Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'PlexFlixNetwork deixará de atualizar ${service}. Reconecte quando quiser.',
			'trackers.connectFailed' => ({required Object service}) => 'Não foi possível conectar ao ${service}. Tente novamente.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Ativar PlexFlixNetwork no ${service}',
