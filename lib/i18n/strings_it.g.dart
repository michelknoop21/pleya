...
class TranslationsIt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsMobileDetailIt mobileDetail = _TranslationsMobileDetailIt._(_root);
	...
	@override late final _TranslationsAddLocalFolderIt addLocalFolder = _TranslationsAddLocalFolderIt._(_root);
...
class _TranslationsAuthIt extends TranslationsAuthEn {
	...
	@override String get authenticationTimeout => 'L\'accesso non è stato completato. Riprova.';
	@override String get usingJellyfinInstead => 'Usi un server Jellyfin? Connettiti a Jellyfin';
...
class _TranslationsSettingsIt extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Supporta Pleya';
	...
	@override String get importSettingsInvalidFile => 'Questo file non è un\'esportazione Pleya valida';
	...
	@override String get startInFullscreenDescription => 'Apri Pleya a schermo intero all\'avvio';
	...
	@override String get startupSectionDescription => 'Scegli quale sezione apre Pleya all\'avvio';
...
class _TranslationsSearchIt extends TranslationsSearchEn {
	...
	@override late final _TranslationsSearchFiltersIt filters = _TranslationsSearchFiltersIt._(_root);
}
...
class _TranslationsMessagesIt extends TranslationsMessagesEn {
	...
	@override String get errorLoading => 'Errore';
	@override String get fileInfoNotAvailable => 'Informazioni sul file non disponibili';
	@override String get errorLoadingFileInfo => 'Errore caricamento informazioni sul file';
	...
	@override String get libraryScanFailed => 'Impossibile eseguire scansione della libreria';
	...
	@override String get metadataRefreshFailed => 'Errore aggiornamento metadati';
	...
	@override String failedPlayback({required Object action}) => 'Impossibile ${action}';
...
class _TranslationsProfilesIt extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPleyaProfile => 'Aggiungi profilo Pleya';
...
class _TranslationsConnectionsIt extends TranslationsConnectionsEn {
	...
	@override String removeSourceConfirm({required Object name}) => 'Rimuovere "${name}" da questo dispositivo? I download vengono conservati.';
}
...
// Path: mobileDetail
class _TranslationsMobileDetailIt extends TranslationsMobileDetailEn {
	_TranslationsMobileDetailIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get similarTab => 'Simili';
	@override String get extrasTab => 'Extra';
}
...
class _TranslationsErrorsIt extends TranslationsErrorsEn {
	...
	// Translations
	@override String get searchFailed => 'Ricerca fallita';
	...
	@override String failedToLoad({required Object context}) => 'Impossibile caricare ${context}';
	@override String get noClientAvailable => 'Nessun client disponibile';
	@override String get authenticationFailed => 'Autenticazione fallita';
	...
	@override String get failedToVerifyToken => 'Verifica token fallita';
...
class _TranslationsLibrariesIt extends TranslationsLibrariesEn {
	...
	@override String get failedToEmptyTrash => 'Impossibile svuotare cestino';
	...
	@override String get failedToAnalyze => 'Impossibile analizzare libreria';
...
class _TranslationsServerSelectionIt extends TranslationsServerSelectionEn {
	...
	@override String get failedToLoadServers => 'Impossibile caricare i server';
}
...
class _TranslationsCollectionsIt extends TranslationsCollectionsEn {
	...
	@override String get deleteFailedWithError => 'Impossibile eliminare la raccolta';
	@override String get failedToLoadItems => 'Impossibile caricare gli elementi della raccolta';
	...
	@override String get removeFromCollectionError => 'Errore durante la rimozione dalla raccolta';
...
class _TranslationsTraktIt extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Pleya smetterà di inviare eventi a Trakt. Puoi riconnetterti quando vuoi.';
	...
	@override String get watchedSyncDescription => 'Quando segni elementi come visti in Pleya, vengono segnati anche su Trakt.';
}
...
class _TranslationsTrackersIt extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleya smetterà di aggiornare ${service}. Riconnetti quando vuoi.';
...
class _TranslationsAddServerIt extends TranslationsAddServerEn {
	...
	@override String get couldNotReachServer => 'Impossibile raggiungere il server';
	@override String get signInFailed => 'Accesso non riuscito';
	@override String get quickConnectFailed => 'Quick Connect non riuscito';
...
// Path: addLocalFolder
class _TranslationsAddLocalFolderIt extends TranslationsAddLocalFolderEn {
	_TranslationsAddLocalFolderIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: pleyaShare
class _TranslationsPleyaShareIt extends TranslationsPleyaShareEn {
	_TranslationsPleyaShareIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get cardTitle => 'Pleya Share';
	@override String get cardSubtitle => 'Connettiti a un altro dispositivo Pleya che condivide i suoi contenuti';
	@override String get hostTitle => 'Condividi i miei contenuti';
	@override String get hostDescription => 'Gli altri dispositivi Pleya su questa rete possono sfogliare, riprodurre e scaricare le tue cartelle locali. Tieni questa schermata aperta durante la condivisione.';
	@override String get hostToggle => 'Condividi cartelle locali';
	@override String get noLocalFolders => 'Aggiungi prima una cartella locale — non c\'è ancora nulla da condividere.';
	@override String get pairCodeLabel => 'Codice di associazione';
	@override String get pairCodeHint => 'Inserisci questo codice sull\'altro dispositivo. Il codice cambia dopo ogni associazione riuscita.';
	@override String get regenerateCode => 'Nuovo codice';
	@override String get pairedDevices => 'Dispositivi associati';
	@override String get noGuests => 'Nessun dispositivo associato';
	@override String get revokeGuest => 'Rimuovi dispositivo';
	@override String get joinTitle => 'Connettiti a Pleya Share';
	@override String get joinDescription => 'Scegli un host trovato sulla rete o inserisci il suo indirizzo, poi digita il codice a 6 cifre mostrato su quel dispositivo.';
	@override String get hostsFound => 'Host sulla tua rete';
	@override String get searching => 'Ricerca host…';
	@override String get noHostsFound => 'Nessun host trovato. Verifica che la condivisione sia attiva e che entrambi i dispositivi siano sulla stessa rete.';
	@override String get refresh => 'Cerca di nuovo';
	@override String get manualHost => 'Indirizzo host (IP)';
	@override String get codeLabel => 'Codice a 6 cifre';
	@override String get connect => 'Connetti';
	@override String get pairFailed => 'Associazione non riuscita. Controlla il codice e riprova.';
	@override String paired({required Object name}) => 'Connesso a ${name}';
	@override String get pairUnreachable => 'Host non raggiungibile. Controlla l\'indirizzo e la rete.';
	@override String get addFolder => 'Aggiungi cartella locale';
	@override String get notificationTitle => 'Condivisione contenuti attiva';
	@override String get notificationText => 'Gli altri dispositivi Pleya possono riprodurre le tue cartelle locali';
	@override String get hostDescriptionAndroid => 'Gli altri dispositivi Pleya su questa rete possono sfogliare, riprodurre e scaricare le tue cartelle locali. La condivisione continua in background con una notifica.';
	@override String get scanningSubnet => 'Scansione della rete…';
}

// Path: sourcePicker
class _TranslationsSourcePickerIt extends TranslationsSourcePickerEn {
	_TranslationsSourcePickerIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get playTitle => 'Scegli dove riprodurre';
	@override String get detailsTitle => 'Scegli una fonte per i dettagli';
	@override String get availableOnOneServer => 'Disponibile su 1 server';
	@override String availableOnManyServers({required Object count}) => 'Disponibile su ${count} server';
	@override String get oneServerUnchecked => 'Impossibile controllare 1 server';
	@override String manyServersUnchecked({required Object count}) => 'Impossibile controllare ${count} server';
	@override String get checkingMoreSources => 'Ricerca di altre fonti…';
	@override String get lastUsed => 'Ultima usata';
	@override String get currentSource => 'Fonte attuale';
	@override String get unavailable => 'Non disponibile';
	@override String get signInRequired => 'È necessario accedere di nuovo';
	@override String resumeAt({required Object position}) => 'Riprendi da ${position}';
	@override String get watched => 'Visto';
	@override String get noneReachableTitle => 'Nessuna fonte è raggiungibile al momento.';
	@override String get reauthRequiredTitle => 'Accedi di nuovo per raggiungere questo titolo.';
	@override String get manageServers => 'Gestisci server';
	...
	@override String setPreferredServer({required Object server}) => 'Usa sempre ${server}';
}

// Path: unifiedCatalog
class _TranslationsUnifiedCatalogIt extends TranslationsUnifiedCatalogEn {
	_TranslationsUnifiedCatalogIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get moviesTitle => 'Film';
	@override String get seriesTitle => 'Serie';
	...
	@override String get loadMore => 'Carica altri';
	@override String get loadingMore => 'Caricamento…';
	@override late final _TranslationsUnifiedCatalogSortIt sort = _TranslationsUnifiedCatalogSortIt._(_root);
	@override late final _TranslationsUnifiedCatalogFiltersIt filters = _TranslationsUnifiedCatalogFiltersIt._(_root);
	@override late final _TranslationsUnifiedCatalogStatesIt states = _TranslationsUnifiedCatalogStatesIt._(_root);
	@override late final _TranslationsUnifiedCatalogSemanticsIt semantics = _TranslationsUnifiedCatalogSemanticsIt._(_root);
	@override late final _TranslationsUnifiedCatalogDiscoveryIt discovery = _TranslationsUnifiedCatalogDiscoveryIt._(_root);
	@override late final _TranslationsUnifiedCatalogHomeIt home = _TranslationsUnifiedCatalogHomeIt._(_root);
}
...
class _TranslationsTvMyPleyaIt extends TranslationsTvMyPleyaEn {
	...
	@override String get activitySubtitle => 'In riproduzione';
	@override String get watchTogetherSubtitle => 'Guarda in sincronia con gli amici';
...
class _TranslationsVideoControlsPipErrorsIt extends TranslationsVideoControlsPipErrorsEn {
	...
	@override String get unknown => 'Si è verificato un errore';
}
...
class _TranslationsCompanionRemotePairingIt extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'I dispositivi Pleya con lo stesso account Plex appaiono qui';
	...
	@override String get noDevicesHint => 'Apri Pleya su desktop e usa lo stesso WiFi';
	...
	@override String get sessionNotFound => 'Dispositivo non trovato. Assicurati che Pleya sia in esecuzione sull\'host.';
	@override String get authFailed => 'Autenticazione non riuscita. Entrambi i dispositivi devono usare lo stesso account Plex.';
	@override String get failedToConnect => 'Connessione fallita';
}
...
class _TranslationsTrackersDeviceCodeIt extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Attiva Pleya su ${service}';
...
class _TranslationsUnifiedCatalogSortIt extends TranslationsUnifiedCatalogSortEn {
	_TranslationsUnifiedCatalogSortIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Ordina';
	@override String get titleAsc => 'Titolo A–Z';
	@override String get titleDesc => 'Titolo Z–A';
	@override String get recentlyAdded => 'Aggiunti di recente';
	@override String get oldestAdded => 'Aggiunti per primi';
	@override String get newestRelease => 'Uscita più recente';
	@override String get oldestRelease => 'Uscita più vecchia';
	@override String get recentlyWatched => 'Visti di recente';
}

// Path: unifiedCatalog.filters
class _TranslationsUnifiedCatalogFiltersIt extends TranslationsUnifiedCatalogFiltersEn {
	_TranslationsUnifiedCatalogFiltersIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsUnifiedCatalogStatesIt extends TranslationsUnifiedCatalogStatesEn {
	_TranslationsUnifiedCatalogStatesIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get emptyTitle => 'Questo catalogo è vuoto';
	@override String get emptyBody => 'Nessuna libreria visibile contiene qualcosa per questa pagina.';
	@override String get filterEmptyTitle => 'Nulla corrisponde a questi filtri';
	@override String get filterEmptyBody => 'Cancella un filtro per vedere altri titoli.';
	@override String get clearFilters => 'Cancella filtri';
	@override String get errorTitle => 'Impossibile caricare il catalogo';
	@override String get errorBody => 'Nessun server ha risposto. Controlla la connessione e riprova.';
	@override String get partialOne => '1 libreria non ha risposto';
	@override String partialMany({required Object count}) => '${count} librerie non hanno risposto';
}

// Path: unifiedCatalog.semantics
class _TranslationsUnifiedCatalogSemanticsIt extends TranslationsUnifiedCatalogSemanticsEn {
	_TranslationsUnifiedCatalogSemanticsIt._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get loadingMore => 'Caricamento di altri titoli';
}

// Path: unifiedCatalog.discovery
class _TranslationsUnifiedCatalogDiscoveryIt extends TranslationsUnifiedCatalogDiscoveryEn {
	_TranslationsUnifiedCatalogDiscoveryIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get allMovies => 'Tutti i film';
	@override String get allSeries => 'Tutte le serie';
	@override String episodeLabel({required Object season, required Object episode}) => 'S${season} E${episode}';
	@override String get partial => 'Alcune sorgenti non hanno risposto';
...
class _TranslationsUnifiedCatalogHomeIt extends TranslationsUnifiedCatalogHomeEn {
	_TranslationsUnifiedCatalogHomeIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsUnifiedCatalogDiscoverySemanticsIt extends TranslationsUnifiedCatalogDiscoverySemanticsEn {
	_TranslationsUnifiedCatalogDiscoverySemanticsIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String section({required Object title, required Object count}) => '${title}, ${count} titoli';
	@override String position({required Object position, required Object count}) => '${position} di ${count}';
	@override String get viewAllMovies => 'Vedi tutti i film, apre il catalogo completo';
	@override String get viewAllSeries => 'Vedi tutte le serie, apre il catalogo completo';
}
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.authenticationTimeout' => 'L\'accesso non è stato completato. Riprova.',
			'auth.usingJellyfinInstead' => 'Usi un server Jellyfin? Connettiti a Jellyfin',
			...
			'settings.supportDeveloper' => 'Supporta Pleya',
			...
			'settings.importSettingsInvalidFile' => 'Questo file non è un\'esportazione Pleya valida',
			...
			'settings.startInFullscreenDescription' => 'Apri Pleya a schermo intero all\'avvio',
			...
			'settings.startupSectionDescription' => 'Scegli quale sezione apre Pleya all\'avvio',
			...
			'search.filters.all' => 'Tutti',
			'search.filters.movies' => 'Film',
			'search.filters.shows' => 'Serie TV',
			'search.filters.episodes' => 'Episodi',
			'search.filters.people' => 'Persone',
			'search.filters.other' => 'Altro',
			...
			'videoControls.pipErrors.unknown' => 'Si è verificato un errore',
			...
			'messages.errorLoading' => 'Errore',
			'messages.fileInfoNotAvailable' => 'Informazioni sul file non disponibili',
			'messages.errorLoadingFileInfo' => 'Errore caricamento informazioni sul file',
			...
			'messages.libraryScanFailed' => 'Impossibile eseguire scansione della libreria',
			...
			'messages.metadataRefreshFailed' => 'Errore aggiornamento metadati',
			...
			'profiles.addPleyaProfile' => 'Aggiungi profilo Pleya',
			...
			'connections.removeSourceConfirm' => ({required Object name}) => 'Rimuovere "${name}" da questo dispositivo? I download vengono conservati.',
			...
			'mobileDetail.similarTab' => 'Simili',
			'mobileDetail.extrasTab' => 'Extra',
			...
			'errors.failedToLoad' => ({required Object context}) => 'Impossibile caricare ${context}',
			'errors.noClientAvailable' => 'Nessun client disponibile',
			'errors.authenticationFailed' => 'Autenticazione fallita',
			...
			'errors.failedToVerifyToken' => 'Verifica token fallita',
			...
			'libraries.failedToEmptyTrash' => 'Impossibile svuotare cestino',
			...
			'libraries.failedToAnalyze' => 'Impossibile analizzare libreria',
			...
			'serverSelection.failedToLoadServers' => 'Impossibile caricare i server',
			...
			'collections.deleteFailedWithError' => 'Impossibile eliminare la raccolta',
			'collections.failedToLoadItems' => 'Impossibile caricare gli elementi della raccolta',
			...
			'collections.removeFromCollectionError' => 'Errore durante la rimozione dalla raccolta',
			...
			'companionRemote.pairing.failedToConnect' => 'Connessione fallita',
			...
			'trakt.disconnectConfirmBody' => 'Pleya smetterà di inviare eventi a Trakt. Puoi riconnetterti quando vuoi.',
			...
			'trakt.watchedSyncDescription' => 'Quando segni elementi come visti in Pleya, vengono segnati anche su Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Pleya smetterà di aggiornare ${service}. Riconnetti quando vuoi.',
			'trackers.connectFailed' => ({required Object service}) => 'Impossibile connettersi a ${service}. Riprova.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Attiva Pleya su ${service}',
			...
			'addServer.couldNotReachServer' => 'Impossibile raggiungere il server',
			'addServer.signInFailed' => 'Accesso non riuscito',
			'addServer.quickConnectFailed' => 'Quick Connect non riuscito',
			...
			'pleyaShare.cardSubtitle' => 'Connettiti a un altro dispositivo Pleya che condivide i suoi contenuti',
			'pleyaShare.hostTitle' => 'Condividi i miei contenuti',
			'pleyaShare.hostDescription' => 'Gli altri dispositivi Pleya su questa rete possono sfogliare, riprodurre e scaricare le tue cartelle locali. Tieni questa schermata aperta durante la condivisione.',
			'pleyaShare.hostToggle' => 'Condividi cartelle locali',
			'pleyaShare.noLocalFolders' => 'Aggiungi prima una cartella locale — non c\'è ancora nulla da condividere.',
			'pleyaShare.pairCodeLabel' => 'Codice di associazione',
			'pleyaShare.pairCodeHint' => 'Inserisci questo codice sull\'altro dispositivo. Il codice cambia dopo ogni associazione riuscita.',
			'pleyaShare.regenerateCode' => 'Nuovo codice',
			'pleyaShare.pairedDevices' => 'Dispositivi associati',
			'pleyaShare.noGuests' => 'Nessun dispositivo associato',
			'pleyaShare.revokeGuest' => 'Rimuovi dispositivo',
			'pleyaShare.joinTitle' => 'Connettiti a Pleya Share',
			'pleyaShare.joinDescription' => 'Scegli un host trovato sulla rete o inserisci il suo indirizzo, poi digita il codice a 6 cifre mostrato su quel dispositivo.',
			'pleyaShare.hostsFound' => 'Host sulla tua rete',
			'pleyaShare.searching' => 'Ricerca host…',
			'pleyaShare.noHostsFound' => 'Nessun host trovato. Verifica che la condivisione sia attiva e che entrambi i dispositivi siano sulla stessa rete.',
			'pleyaShare.refresh' => 'Cerca di nuovo',
			'pleyaShare.manualHost' => 'Indirizzo host (IP)',
			'pleyaShare.codeLabel' => 'Codice a 6 cifre',
			'pleyaShare.connect' => 'Connetti',
			'pleyaShare.pairFailed' => 'Associazione non riuscita. Controlla il codice e riprova.',
			'pleyaShare.paired' => ({required Object name}) => 'Connesso a ${name}',
			'pleyaShare.pairUnreachable' => 'Host non raggiungibile. Controlla l\'indirizzo e la rete.',
			'pleyaShare.addFolder' => 'Aggiungi cartella locale',
			'pleyaShare.notificationTitle' => 'Condivisione contenuti attiva',
			'pleyaShare.notificationText' => 'Gli altri dispositivi Pleya possono riprodurre le tue cartelle locali',
			'pleyaShare.hostDescriptionAndroid' => 'Gli altri dispositivi Pleya su questa rete possono sfogliare, riprodurre e scaricare le tue cartelle locali. La condivisione continua in background con una notifica.',
			'pleyaShare.scanningSubnet' => 'Scansione della rete…',
			'sourcePicker.playTitle' => 'Scegli dove riprodurre',
			'sourcePicker.detailsTitle' => 'Scegli una fonte per i dettagli',
			'sourcePicker.availableOnOneServer' => 'Disponibile su 1 server',
			'sourcePicker.availableOnManyServers' => ({required Object count}) => 'Disponibile su ${count} server',
			'sourcePicker.oneServerUnchecked' => 'Impossibile controllare 1 server',
			'sourcePicker.manyServersUnchecked' => ({required Object count}) => 'Impossibile controllare ${count} server',
			'sourcePicker.checkingMoreSources' => 'Ricerca di altre fonti…',
			'sourcePicker.lastUsed' => 'Ultima usata',
			'sourcePicker.currentSource' => 'Fonte attuale',
			'sourcePicker.unavailable' => 'Non disponibile',
			'sourcePicker.signInRequired' => 'È necessario accedere di nuovo',
			'sourcePicker.resumeAt' => ({required Object position}) => 'Riprendi da ${position}',
			'sourcePicker.watched' => 'Visto',
			'sourcePicker.noneReachableTitle' => 'Nessuna fonte è raggiungibile al momento.',
			'sourcePicker.reauthRequiredTitle' => 'Accedi di nuovo per raggiungere questo titolo.',
			'sourcePicker.manageServers' => 'Gestisci server',
			...
			'sourcePicker.setPreferredServer' => ({required Object server}) => 'Usa sempre ${server}',
			'unifiedCatalog.moviesTitle' => 'Film',
			'unifiedCatalog.seriesTitle' => 'Serie',
			...
			'unifiedCatalog.loadMore' => 'Carica altri',
			'unifiedCatalog.loadingMore' => 'Caricamento…',
			'unifiedCatalog.sort.title' => 'Ordina',
			'unifiedCatalog.sort.titleAsc' => 'Titolo A–Z',
			'unifiedCatalog.sort.titleDesc' => 'Titolo Z–A',
			'unifiedCatalog.sort.recentlyAdded' => 'Aggiunti di recente',
			'unifiedCatalog.sort.oldestAdded' => 'Aggiunti per primi',
			'unifiedCatalog.sort.newestRelease' => 'Uscita più recente',
			'unifiedCatalog.sort.oldestRelease' => 'Uscita più vecchia',
			'unifiedCatalog.sort.recentlyWatched' => 'Visti di recente',
			'unifiedCatalog.filters.title' => 'Filtri',
			'unifiedCatalog.filters.status' => 'Stato',
			'unifiedCatalog.filters.genre' => 'Genere',
			'unifiedCatalog.filters.year' => 'Anno',
			'unifiedCatalog.filters.servers' => 'Server',
			'unifiedCatalog.filters.libraries' => 'Librerie',
			'unifiedCatalog.filters.apply' => 'Applica',
			'unifiedCatalog.filters.clearAll' => 'Cancella tutto',
			...
			'unifiedCatalog.states.filterEmptyTitle' => 'Nulla corrisponde a questi filtri',
			'unifiedCatalog.states.filterEmptyBody' => 'Cancella un filtro per vedere altri titoli.',
			'unifiedCatalog.states.clearFilters' => 'Cancella filtri',
			'unifiedCatalog.states.errorTitle' => 'Impossibile caricare il catalogo',
			'unifiedCatalog.states.errorBody' => 'Nessun server ha risposto. Controlla la connessione e riprova.',
			'unifiedCatalog.states.partialOne' => '1 libreria non ha risposto',
			'unifiedCatalog.states.partialMany' => ({required Object count}) => '${count} librerie non hanno risposto',
			'unifiedCatalog.semantics.watched' => 'Visto',
			'unifiedCatalog.semantics.inProgress' => 'In corso',
			'unifiedCatalog.semantics.loadingMore' => 'Caricamento di altri titoli',
			'unifiedCatalog.discovery.allMovies' => 'Tutti i film',
			'unifiedCatalog.discovery.allSeries' => 'Tutte le serie',
			'unifiedCatalog.discovery.episodeLabel' => ({required Object season, required Object episode}) => 'S${season} E${episode}',
			'unifiedCatalog.discovery.partial' => 'Alcune sorgenti non hanno risposto',
			'unifiedCatalog.discovery.emptyTitle' => 'Ancora niente da scoprire',
			'unifiedCatalog.discovery.emptyBody' => 'Nessuna libreria visibile ha qualcosa da mostrare qui.',
			'unifiedCatalog.discovery.semantics.section' => ({required Object title, required Object count}) => '${title}, ${count} titoli',
			...
			'tvMyPleya.activitySubtitle' => 'In riproduzione',
			'tvMyPleya.watchTogetherSubtitle' => 'Guarda in sincronia con gli amici',
