...
class _TranslationsSettingsBg extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Подкрепи PlexFlixNetwork';
	...
	@override String get importSettingsInvalidFile => 'Този файл не е валиден експорт на настройки от PlexFlixNetwork';
	...
	@override String get startInFullscreenDescription => 'Отваряй PlexFlixNetwork в режим цял екран при стартиране';
	...
	@override String get startupSectionDescription => 'Изберете кой раздел да отваря PlexFlixNetwork при стартиране';
...
class _TranslationsProfilesBg extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPlezyProfile => 'Добави PlexFlixNetwork профил';
...
class _TranslationsConnectionsBg extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Добавете или премахнете URL адреси за ${serverName}. PlexFlixNetwork ще използва достъпния URL адрес с най-ниска латентност.';
}
...
class _TranslationsTraktBg extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'PlexFlixNetwork ще спре да изпраща събития към Trakt. Можете да се свържете отново по всяко време.';
	...
	@override String get watchedSyncDescription => 'Когато маркирате елементи като гледани в PlexFlixNetwork, маркирай ги и в Trakt.';
}
...
class _TranslationsTrackersBg extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'PlexFlixNetwork ще спре да обновява ${service}. Можете да се свържете отново по всяко време.';
...
class _TranslationsCompanionRemotePairingBg extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'PlexFlixNetwork устройства със същия Plex акаунт се показват тук';
	...
	@override String get noDevicesHint => 'Отворете PlexFlixNetwork на настолен компютър и използвайте същия WiFi';
	...
	@override String get sessionNotFound => 'Устройството не е намерено. Уверете се, че PlexFlixNetwork работи на хоста.';
...
class _TranslationsTrackersDeviceCodeBg extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Активиране на PlexFlixNetwork в ${service}';
...
extension on TranslationsBg {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Подкрепи PlexFlixNetwork',
			...
			'settings.importSettingsInvalidFile' => 'Този файл не е валиден експорт на настройки от PlexFlixNetwork',
			...
			'settings.startInFullscreenDescription' => 'Отваряй PlexFlixNetwork в режим цял екран при стартиране',
			...
			'settings.startupSectionDescription' => 'Изберете кой раздел да отваря PlexFlixNetwork при стартиране',
			...
			'profiles.addPlezyProfile' => 'Добави PlexFlixNetwork профил',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Добавете или премахнете URL адреси за ${serverName}. PlexFlixNetwork ще използва достъпния URL адрес с най-ниска латентност.',
			...
			'companionRemote.pairing.discoveryDescription' => 'PlexFlixNetwork устройства със същия Plex акаунт се показват тук',
			...
			'companionRemote.pairing.noDevicesHint' => 'Отворете PlexFlixNetwork на настолен компютър и използвайте същия WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Устройството не е намерено. Уверете се, че PlexFlixNetwork работи на хоста.',
			...
			'trakt.disconnectConfirmBody' => 'PlexFlixNetwork ще спре да изпраща събития към Trakt. Можете да се свържете отново по всяко време.',
			...
			'trakt.watchedSyncDescription' => 'Когато маркирате елементи като гледани в PlexFlixNetwork, маркирай ги и в Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'PlexFlixNetwork ще спре да обновява ${service}. Можете да се свържете отново по всяко време.',
			'trackers.connectFailed' => ({required Object service}) => 'Неуспешно свързване с ${service}. Опитайте отново.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Активиране на PlexFlixNetwork в ${service}',
