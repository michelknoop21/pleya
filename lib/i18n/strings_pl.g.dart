...
class _TranslationsSettingsPl extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Wesprzyj Pleya';
	...
	@override String get importSettingsInvalidFile => 'Ten plik nie jest prawidłowym eksportem Pleya';
	...
	@override String get startInFullscreenDescription => 'Otwiera Pleya w trybie pełnoekranowym przy uruchomieniu';
	...
	@override String get startupSectionDescription => 'Wybierz, którą sekcję Pleya otwiera przy uruchomieniu';
...
class _TranslationsVideoControlsPl extends TranslationsVideoControlsEn {
	...
	@override String subtitleTrackNumber({required Object number}) => 'Napisy ${number}';
	@override String audioTrackNumber({required Object number}) => 'Ścieżka audio ${number}';
...
class _TranslationsMessagesPl extends TranslationsMessagesEn {
	...
	@override String get errorLoading => 'Błąd';
	@override String get fileInfoNotAvailable => 'Informacje o pliku niedostępne';
	@override String get errorLoadingFileInfo => 'Błąd ładowania informacji o pliku';
	...
	@override String get libraryScanFailed => 'Nie udało się zeskanować biblioteki';
	...
	@override String get metadataRefreshFailed => 'Nie udało się odświeżyć metadanych';
	...
	@override String failedPlayback({required Object action}) => 'Nie udało się ${action}';
...
class _TranslationsProfilesPl extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPleyaProfile => 'Dodaj profil Pleya';
...
class _TranslationsErrorsPl extends TranslationsErrorsEn {
	...
	// Translations
	@override String get searchFailed => 'Wyszukiwanie nie powiodło się';
	...
	@override String failedToLoad({required Object context}) => 'Nie udało się załadować ${context}';
	@override String get noClientAvailable => 'Brak dostępnego klienta';
	@override String get authenticationFailed => 'Uwierzytelnienie nie powiodło się';
	...
	@override String get failedToVerifyToken => 'Nie udało się zweryfikować tokena';
...
class _TranslationsLibrariesPl extends TranslationsLibrariesEn {
	...
	@override String get failedToEmptyTrash => 'Nie udało się opróżnić kosza';
	...
	@override String get failedToAnalyze => 'Nie udało się przeanalizować biblioteki';
...
class _TranslationsServerSelectionPl extends TranslationsServerSelectionEn {
	...
	@override String get failedToLoadServers => 'Nie udało się załadować serwerów';
}
...
class _TranslationsCollectionsPl extends TranslationsCollectionsEn {
	...
	@override String get deleteFailedWithError => 'Nie udało się usunąć kolekcji';
	@override String get failedToLoadItems => 'Nie udało się załadować elementów kolekcji';
	...
	@override String get removeFromCollectionError => 'Błąd usuwania z kolekcji';
...
class _TranslationsTraktPl extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Pleya przestanie wysyłać zdarzenia do Trakt. Możesz połączyć ponownie w dowolnym momencie.';
	...
	@override String get watchedSyncDescription => 'Gdy oznaczysz pozycje jako obejrzane w Pleya, zostaną też oznaczone w Trakt.';
}
...
class _TranslationsTrackersPl extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleya przestanie aktualizować ${service}. Połącz ponownie w dowolnym momencie.';
...
class _TranslationsAddServerPl extends TranslationsAddServerEn {
	...
	@override String get couldNotReachServer => 'Nie udało się połączyć z serwerem';
	@override String get signInFailed => 'Logowanie nie powiodło się';
	@override String get quickConnectFailed => 'Quick Connect nie powiodło się';
...
// Path: addLocalFolder
class _TranslationsAddLocalFolderPl extends TranslationsAddLocalFolderEn {
	_TranslationsAddLocalFolderPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: pleyaShare
class _TranslationsPleyaSharePl extends TranslationsPleyaShareEn {
	_TranslationsPleyaSharePl._(TranslationsPl root) : this._root = root, super.internal(root);

	final TranslationsPl _root; // ignore: unused_field

	// Translations
	@override String get cardTitle => 'Pleya Share';
	@override String get cardSubtitle => 'Połącz się z innym urządzeniem Pleya udostępniającym multimedia';
	@override String get hostTitle => 'Udostępnij moje multimedia';
	@override String get hostDescription => 'Inne urządzenia Pleya w tej sieci mogą przeglądać, odtwarzać i pobierać twoje lokalne foldery. Podczas udostępniania nie zamykaj tego ekranu.';
	@override String get hostToggle => 'Udostępniaj lokalne foldery';
	@override String get noLocalFolders => 'Najpierw dodaj folder lokalny — nie ma jeszcze nic do udostępnienia.';
	@override String get pairCodeLabel => 'Kod parowania';
	@override String get pairCodeHint => 'Wpisz ten kod na drugim urządzeniu. Kod zmienia się po każdym udanym parowaniu.';
	@override String get regenerateCode => 'Nowy kod';
	@override String get pairedDevices => 'Sparowane urządzenia';
	@override String get noGuests => 'Brak sparowanych urządzeń';
	@override String get revokeGuest => 'Usuń urządzenie';
	@override String get joinTitle => 'Połącz z Pleya Share';
	@override String get joinDescription => 'Wybierz hosta znalezionego w sieci lub wpisz jego adres, a następnie wprowadź 6-cyfrowy kod wyświetlony na tamtym urządzeniu.';
	@override String get hostsFound => 'Hosty w twojej sieci';
	@override String get searching => 'Szukanie hostów…';
	@override String get noHostsFound => 'Nie znaleziono hostów. Upewnij się, że udostępnianie jest włączone i oba urządzenia są w tej samej sieci.';
	@override String get refresh => 'Szukaj ponownie';
	@override String get manualHost => 'Adres hosta (IP)';
	@override String get codeLabel => 'Kod 6-cyfrowy';
	@override String get connect => 'Połącz';
	@override String get pairFailed => 'Parowanie nie powiodło się. Sprawdź kod i spróbuj ponownie.';
...
class _TranslationsVideoControlsPipErrorsPl extends TranslationsVideoControlsPipErrorsEn {
	...
	@override String get unknown => 'Wystąpił błąd';
}
...
class _TranslationsCompanionRemotePairingPl extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Urządzenia Pleya z tym samym kontem Plex pojawią się tutaj';
	...
	@override String get noDevicesHint => 'Otwórz Pleya na komputerze i użyj tego samego WiFi';
	...
	@override String get sessionNotFound => 'Nie znaleziono urządzenia. Upewnij się, że Pleya działa na hoście.';
	@override String get authFailed => 'Uwierzytelnianie nie powiodło się. Oba urządzenia muszą używać tego samego konta Plex.';
	@override String get failedToConnect => 'Nie udało się połączyć';
}
...
class _TranslationsTrackersDeviceCodePl extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Aktywuj Pleya w ${service}';
...
extension on TranslationsPl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Wesprzyj Pleya',
			...
			'settings.importSettingsInvalidFile' => 'Ten plik nie jest prawidłowym eksportem Pleya',
			...
			'settings.startInFullscreenDescription' => 'Otwiera Pleya w trybie pełnoekranowym przy uruchomieniu',
			...
			'settings.startupSectionDescription' => 'Wybierz, którą sekcję Pleya otwiera przy uruchomieniu',
			...
			'videoControls.subtitleTrackNumber' => ({required Object number}) => 'Napisy ${number}',
			'videoControls.audioTrackNumber' => ({required Object number}) => 'Ścieżka audio ${number}',
			...
			'videoControls.pipErrors.unknown' => 'Wystąpił błąd',
			...
			'messages.errorLoading' => 'Błąd',
			'messages.fileInfoNotAvailable' => 'Informacje o pliku niedostępne',
			'messages.errorLoadingFileInfo' => 'Błąd ładowania informacji o pliku',
			...
			'messages.libraryScanFailed' => 'Nie udało się zeskanować biblioteki',
			...
			'messages.metadataRefreshFailed' => 'Nie udało się odświeżyć metadanych',
			...
			'profiles.addPleyaProfile' => 'Dodaj profil Pleya',
			...
			'errors.failedToLoad' => ({required Object context}) => 'Nie udało się załadować ${context}',
			'errors.noClientAvailable' => 'Brak dostępnego klienta',
			'errors.authenticationFailed' => 'Uwierzytelnienie nie powiodło się',
			...
			'errors.failedToVerifyToken' => 'Nie udało się zweryfikować tokena',
			...
			'libraries.failedToEmptyTrash' => 'Nie udało się opróżnić kosza',
			...
			'libraries.failedToAnalyze' => 'Nie udało się przeanalizować biblioteki',
			...
			'serverSelection.failedToLoadServers' => 'Nie udało się załadować serwerów',
			...
			'collections.deleteFailedWithError' => 'Nie udało się usunąć kolekcji',
			'collections.failedToLoadItems' => 'Nie udało się załadować elementów kolekcji',
			...
			'collections.removeFromCollectionError' => 'Błąd usuwania z kolekcji',
			...
			'companionRemote.pairing.failedToConnect' => 'Nie udało się połączyć',
			...
			'trakt.disconnectConfirmBody' => 'Pleya przestanie wysyłać zdarzenia do Trakt. Możesz połączyć ponownie w dowolnym momencie.',
			...
			'trakt.watchedSyncDescription' => 'Gdy oznaczysz pozycje jako obejrzane w Pleya, zostaną też oznaczone w Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Pleya przestanie aktualizować ${service}. Połącz ponownie w dowolnym momencie.',
			'trackers.connectFailed' => ({required Object service}) => 'Nie udało się połączyć z ${service}. Spróbuj ponownie.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Aktywuj Pleya w ${service}',
			...
			'addServer.couldNotReachServer' => 'Nie udało się połączyć z serwerem',
			'addServer.signInFailed' => 'Logowanie nie powiodło się',
			'addServer.quickConnectFailed' => 'Quick Connect nie powiodło się',
			...
			'pleyaShare.cardSubtitle' => 'Połącz się z innym urządzeniem Pleya udostępniającym multimedia',
			'pleyaShare.hostTitle' => 'Udostępnij moje multimedia',
			'pleyaShare.hostDescription' => 'Inne urządzenia Pleya w tej sieci mogą przeglądać, odtwarzać i pobierać twoje lokalne foldery. Podczas udostępniania nie zamykaj tego ekranu.',
			'pleyaShare.hostToggle' => 'Udostępniaj lokalne foldery',
			'pleyaShare.noLocalFolders' => 'Najpierw dodaj folder lokalny — nie ma jeszcze nic do udostępnienia.',
			'pleyaShare.pairCodeLabel' => 'Kod parowania',
			'pleyaShare.pairCodeHint' => 'Wpisz ten kod na drugim urządzeniu. Kod zmienia się po każdym udanym parowaniu.',
			'pleyaShare.regenerateCode' => 'Nowy kod',
			'pleyaShare.pairedDevices' => 'Sparowane urządzenia',
			'pleyaShare.noGuests' => 'Brak sparowanych urządzeń',
			'pleyaShare.revokeGuest' => 'Usuń urządzenie',
			'pleyaShare.joinTitle' => 'Połącz z Pleya Share',
			'pleyaShare.joinDescription' => 'Wybierz hosta znalezionego w sieci lub wpisz jego adres, a następnie wprowadź 6-cyfrowy kod wyświetlony na tamtym urządzeniu.',
			'pleyaShare.hostsFound' => 'Hosty w twojej sieci',
			'pleyaShare.searching' => 'Szukanie hostów…',
			'pleyaShare.noHostsFound' => 'Nie znaleziono hostów. Upewnij się, że udostępnianie jest włączone i oba urządzenia są w tej samej sieci.',
			'pleyaShare.refresh' => 'Szukaj ponownie',
			'pleyaShare.manualHost' => 'Adres hosta (IP)',
			'pleyaShare.codeLabel' => 'Kod 6-cyfrowy',
			'pleyaShare.connect' => 'Połącz',
			'pleyaShare.pairFailed' => 'Parowanie nie powiodło się. Sprawdź kod i spróbuj ponownie.',
