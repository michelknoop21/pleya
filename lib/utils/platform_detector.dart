...
class TvDetectionService {
  ...
  /// Forces the TV flag without implying Apple TV, so a test can cover the
  /// Android TV branch of paths that treat the two differently (the back key
  /// runs on key-up there and on key-down on Apple TV).
  @visibleForTesting
