...
/// `unified_catalog_provider.dart`'s job (also fase 3): the loading flags
/// live on the provider, not here, so this type never carries a field
/// nothing in this file sets.
library;
