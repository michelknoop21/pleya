...
import 'sections/tv_personal_media_overview_screens.dart';
...
TvNestedRoute tvMyPleyaNestedRoute(
  TvMyPleyaSection section, {
  GlobalKey? librariesKey,
  GlobalKey? watchlistKey,
  GlobalKey? collectionsKey,
  GlobalKey? playlistsKey,
}) => TvNestedRoute(
  ...
  screenKey: switch (section) {
    ...
    TvMyPleyaSection.collections => collectionsKey,
    TvMyPleyaSection.playlists => playlistsKey,
  ...
  builder: (context) => AutomationNode(
    ...
    child: switch (section) {
      ...
      TvMyPleyaSection.collections => TvCollectionsOverviewScreen(key: collectionsKey),
      TvMyPleyaSection.playlists => TvPlaylistsOverviewScreen(key: playlistsKey),
