...
class $AffinitySnapshotsTable extends AffinitySnapshots with TableInfo<$AffinitySnapshotsTable, AffinitySnapshotRow> {
  ...
  @override
  List<GeneratedColumn> get $columns => [profileId, vectorJson, eventCount, computedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class AffinitySnapshotRow extends DataClass implements Insertable<AffinitySnapshotRow> {
  ...
  AffinitySnapshotRow copyWith({String? profileId, String? vectorJson, int? eventCount, int? computedAt}) =>
      AffinitySnapshotRow(
        profileId: profileId ?? this.profileId,
  ...
  @override
  int get hashCode => Object.hash(profileId, vectorJson, eventCount, computedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
