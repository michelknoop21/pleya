...
class $DownloadedMediaTable extends DownloadedMedia with TableInfo<$DownloadedMediaTable, DownloadedMediaItem> {
  ...
  static const VerificationMeta _autoPausedMeta = const VerificationMeta('autoPaused');
  @override
  late final GeneratedColumn<bool> autoPaused = GeneratedColumn<bool>(
    'auto_paused',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways('CHECK ("auto_paused" IN (0, 1))'),
  ...
  VerificationContext validateIntegrity(Insertable<DownloadedMediaItem> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('auto_paused')) {
      context.handle(_autoPausedMeta, autoPaused.isAcceptableOrUnknown(data['auto_paused']!, _autoPausedMeta));
    }
  ...
  DownloadedMediaItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DownloadedMediaItem(
      ...
      autoPaused: attachedDatabase.typeMapping.read(DriftSqlType.bool, data['${effectivePrefix}auto_paused'])!,
...
class DownloadedMediaItem extends DataClass implements Insertable<DownloadedMediaItem> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['auto_paused'] = Variable<bool>(autoPaused);
  ...
  factory DownloadedMediaItem.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    ...
    return DownloadedMediaItem(
      ...
      autoPaused: serializer.fromJson<bool>(json['autoPaused']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'autoPaused': serializer.toJson<bool>(autoPaused),
  ...
  DownloadedMediaItem copyWithCompanion(DownloadedMediaCompanion data) {
    return DownloadedMediaItem(
      ...
      autoPaused: data.autoPaused.present ? data.autoPaused.value : this.autoPaused,
  ...
  bool operator ==(Object other) =>
      ...
      (other is DownloadedMediaItem &&
          ...
          other.autoPaused == this.autoPaused &&
...
class DownloadedMediaCompanion extends UpdateCompanion<DownloadedMediaItem> {
  ...
  const DownloadedMediaCompanion({
    ...
    this.autoPaused = const Value.absent(),
  ...
  static Insertable<DownloadedMediaItem> custom({
    ...
    return RawValuesInsertable({
      ...
      if (autoPaused != null) 'auto_paused': autoPaused,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (autoPaused.present) {
      map['auto_paused'] = Variable<bool>(autoPaused.value);
    }
...
class $MediaInteractionsTable extends MediaInteractions with TableInfo<$MediaInteractionsTable, MediaInteractionRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _mediaKindMeta = const VerificationMeta('mediaKind');
  @override
  ...
  static const VerificationMeta _eventWeightMeta = const VerificationMeta('eventWeight');
  @override
  ...
  static const VerificationMeta _genresJsonMeta = const VerificationMeta('genresJson');
  @override
  ...
  static const VerificationMeta _actorsJsonMeta = const VerificationMeta('actorsJson');
  @override
  ...
  static const VerificationMeta _directorsJsonMeta = const VerificationMeta('directorsJson');
  @override
  ...
  static const VerificationMeta _moodsJsonMeta = const VerificationMeta('moodsJson');
  @override
  ...
  static const VerificationMeta _communityRatingMeta = const VerificationMeta('communityRating');
  @override
  ...
  static const VerificationMeta _seriesKeyMeta = const VerificationMeta('seriesKey');
  @override
  ...
  static const VerificationMeta _sourceEventIdMeta = const VerificationMeta('sourceEventId');
  @override
  ...
  static const VerificationMeta _sourceServerIdMeta = const VerificationMeta('sourceServerId');
  @override
  ...
  static const VerificationMeta _completionPercentMeta = const VerificationMeta('completionPercent');
  @override
  ...
  static const VerificationMeta _playSecondsMeta = const VerificationMeta('playSeconds');
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<MediaInteractionRow> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
      context.handle(_idMeta, id.isAcceptableOrUnknown(data['id']!, _idMeta));
    ...
    if (data.containsKey('media_kind')) {
      context.handle(_mediaKindMeta, mediaKind.isAcceptableOrUnknown(data['media_kind']!, _mediaKindMeta));
    } else if (isInserting) {
    ...
    if (data.containsKey('event_weight')) {
      context.handle(_eventWeightMeta, eventWeight.isAcceptableOrUnknown(data['event_weight']!, _eventWeightMeta));
    } else if (isInserting) {
    ...
    if (data.containsKey('genres_json')) {
      context.handle(_genresJsonMeta, genresJson.isAcceptableOrUnknown(data['genres_json']!, _genresJsonMeta));
    }
    if (data.containsKey('actors_json')) {
      context.handle(_actorsJsonMeta, actorsJson.isAcceptableOrUnknown(data['actors_json']!, _actorsJsonMeta));
    }
    if (data.containsKey('directors_json')) {
      context.handle(
        _directorsJsonMeta,
        directorsJson.isAcceptableOrUnknown(data['directors_json']!, _directorsJsonMeta),
      );
    }
    if (data.containsKey('moods_json')) {
      context.handle(_moodsJsonMeta, moodsJson.isAcceptableOrUnknown(data['moods_json']!, _moodsJsonMeta));
    }
    if (data.containsKey('studio')) {
      context.handle(_studioMeta, studio.isAcceptableOrUnknown(data['studio']!, _studioMeta));
    }
    ...
    if (data.containsKey('community_rating')) {
      context.handle(
        ...
        communityRating.isAcceptableOrUnknown(data['community_rating']!, _communityRatingMeta),
      );
    }
    if (data.containsKey('series_key')) {
      context.handle(_seriesKeyMeta, seriesKey.isAcceptableOrUnknown(data['series_key']!, _seriesKeyMeta));
    }
    ...
    if (data.containsKey('source_event_id')) {
      context.handle(
        _sourceEventIdMeta,
        sourceEventId.isAcceptableOrUnknown(data['source_event_id']!, _sourceEventIdMeta),
      );
    }
    if (data.containsKey('source_server_id')) {
      context.handle(
        _sourceServerIdMeta,
        sourceServerId.isAcceptableOrUnknown(data['source_server_id']!, _sourceServerIdMeta),
      );
    }
    if (data.containsKey('completion_percent')) {
      context.handle(
        _completionPercentMeta,
        completionPercent.isAcceptableOrUnknown(data['completion_percent']!, _completionPercentMeta),
      );
    }
    if (data.containsKey('play_seconds')) {
      context.handle(_playSecondsMeta, playSeconds.isAcceptableOrUnknown(data['play_seconds']!, _playSecondsMeta));
    }
    return context;
  }
  ...
  MediaInteractionRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MediaInteractionRow(
      ...
      profileId: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}profile_id'])!,
      globalKey: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}global_key'])!,
      mediaKind: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}media_kind'])!,
      eventType: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}event_type'])!,
      eventWeight: attachedDatabase.typeMapping.read(DriftSqlType.double, data['${effectivePrefix}event_weight'])!,
      occurredAt: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}occurred_at'])!,
      genresJson: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}genres_json'])!,
      actorsJson: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}actors_json'])!,
      directorsJson: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}directors_json'])!,
      moodsJson: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}moods_json'])!,
      studio: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}studio']),
      ...
      seriesKey: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}series_key']),
      source: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}source'])!,
      sourceEventId: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}source_event_id']),
      ...
      playSeconds: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}play_seconds']),
    );
  }
...
class MediaInteractionRow extends DataClass implements Insertable<MediaInteractionRow> {
  final int id;
  ...
  MediaInteractionsCompanion toCompanion(bool nullToAbsent) {
    return MediaInteractionsCompanion(
      ...
      studio: studio == null && nullToAbsent ? const Value.absent() : Value(studio),
      year: year == null && nullToAbsent ? const Value.absent() : Value(year),
      communityRating: communityRating == null && nullToAbsent ? const Value.absent() : Value(communityRating),
      seriesKey: seriesKey == null && nullToAbsent ? const Value.absent() : Value(seriesKey),
      source: Value(source),
      sourceEventId: sourceEventId == null && nullToAbsent ? const Value.absent() : Value(sourceEventId),
      sourceServerId: sourceServerId == null && nullToAbsent ? const Value.absent() : Value(sourceServerId),
      completionPercent: completionPercent == null && nullToAbsent ? const Value.absent() : Value(completionPercent),
      playSeconds: playSeconds == null && nullToAbsent ? const Value.absent() : Value(playSeconds),
    );
  }

  factory MediaInteractionRow.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return MediaInteractionRow(
      id: serializer.fromJson<int>(json['id']),
      profileId: serializer.fromJson<String>(json['profileId']),
  ...
  MediaInteractionRow copyWith({
    ...
    communityRating: communityRating.present ? communityRating.value : this.communityRating,
    seriesKey: seriesKey.present ? seriesKey.value : this.seriesKey,
    source: source ?? this.source,
    sourceEventId: sourceEventId.present ? sourceEventId.value : this.sourceEventId,
    sourceServerId: sourceServerId.present ? sourceServerId.value : this.sourceServerId,
    completionPercent: completionPercent.present ? completionPercent.value : this.completionPercent,
  ...
  MediaInteractionRow copyWithCompanion(MediaInteractionsCompanion data) {
    return MediaInteractionRow(
      ...
      eventWeight: data.eventWeight.present ? data.eventWeight.value : this.eventWeight,
      occurredAt: data.occurredAt.present ? data.occurredAt.value : this.occurredAt,
      genresJson: data.genresJson.present ? data.genresJson.value : this.genresJson,
      actorsJson: data.actorsJson.present ? data.actorsJson.value : this.actorsJson,
      directorsJson: data.directorsJson.present ? data.directorsJson.value : this.directorsJson,
      ...
      communityRating: data.communityRating.present ? data.communityRating.value : this.communityRating,
      seriesKey: data.seriesKey.present ? data.seriesKey.value : this.seriesKey,
      source: data.source.present ? data.source.value : this.source,
      sourceEventId: data.sourceEventId.present ? data.sourceEventId.value : this.sourceEventId,
      sourceServerId: data.sourceServerId.present ? data.sourceServerId.value : this.sourceServerId,
      completionPercent: data.completionPercent.present ? data.completionPercent.value : this.completionPercent,
      playSeconds: data.playSeconds.present ? data.playSeconds.value : this.playSeconds,
    );
  }
...
class $AffinitySnapshotsTable extends AffinitySnapshots with TableInfo<$AffinitySnapshotsTable, AffinitySnapshotRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _vectorJsonMeta = const VerificationMeta('vectorJson');
  @override
  ...
  static const VerificationMeta _eventCountMeta = const VerificationMeta('eventCount');
  @override
  ...
  static const VerificationMeta _enabledKeyMeta = const VerificationMeta('enabledKey');
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [profileId, vectorJson, eventCount, computedAt, enabledKey];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<AffinitySnapshotRow> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('profile_id')) {
      context.handle(_profileIdMeta, profileId.isAcceptableOrUnknown(data['profile_id']!, _profileIdMeta));
    ...
    if (data.containsKey('vector_json')) {
      context.handle(_vectorJsonMeta, vectorJson.isAcceptableOrUnknown(data['vector_json']!, _vectorJsonMeta));
    } else if (isInserting) {
      context.missing(_vectorJsonMeta);
    }
    if (data.containsKey('event_count')) {
      context.handle(_eventCountMeta, eventCount.isAcceptableOrUnknown(data['event_count']!, _eventCountMeta));
    } else if (isInserting) {
      context.missing(_eventCountMeta);
    }
    if (data.containsKey('computed_at')) {
      context.handle(_computedAtMeta, computedAt.isAcceptableOrUnknown(data['computed_at']!, _computedAtMeta));
    } else if (isInserting) {
      context.missing(_computedAtMeta);
    }
    if (data.containsKey('enabled_key')) {
      context.handle(_enabledKeyMeta, enabledKey.isAcceptableOrUnknown(data['enabled_key']!, _enabledKeyMeta));
    }
    return context;
  }
  ...
  AffinitySnapshotRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AffinitySnapshotRow(
      profileId: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}profile_id'])!,
      vectorJson: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}vector_json'])!,
      eventCount: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}event_count'])!,
      computedAt: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}computed_at'])!,
      enabledKey: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}enabled_key'])!,
    );
  }
...
class AffinitySnapshotRow extends DataClass implements Insertable<AffinitySnapshotRow> {
  final String profileId;
  ...
  factory AffinitySnapshotRow.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return AffinitySnapshotRow(
      profileId: serializer.fromJson<String>(json['profileId']),
  ...
  AffinitySnapshotRow copyWithCompanion(AffinitySnapshotsCompanion data) {
    return AffinitySnapshotRow(
      profileId: data.profileId.present ? data.profileId.value : this.profileId,
      vectorJson: data.vectorJson.present ? data.vectorJson.value : this.vectorJson,
      eventCount: data.eventCount.present ? data.eventCount.value : this.eventCount,
      computedAt: data.computedAt.present ? data.computedAt.value : this.computedAt,
      enabledKey: data.enabledKey.present ? data.enabledKey.value : this.enabledKey,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(profileId, vectorJson, eventCount, computedAt, enabledKey);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $HistorySyncCursorsTable extends HistorySyncCursors
  ...
  static const VerificationMeta _forwardCursorAtMeta = const VerificationMeta('forwardCursorAt');
  @override
  ...
  static const VerificationMeta _forwardLastRowIdMeta = const VerificationMeta('forwardLastRowId');
  @override
  ...
  static const VerificationMeta _backfillBeforeDayMeta = const VerificationMeta('backfillBeforeDay');
  @override
  late final GeneratedColumn<String> backfillBeforeDay = GeneratedColumn<String>(
    'backfill_before_day',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _backfillOffsetMeta = const VerificationMeta('backfillOffset');
  @override
  ...
  static const VerificationMeta _backfillCursorAtMeta = const VerificationMeta('backfillCursorAt');
  @override
  ...
  static const VerificationMeta _backfillStateMeta = const VerificationMeta('backfillState');
  @override
  ...
  static const VerificationMeta _forwardTruncationCountMeta = const VerificationMeta('forwardTruncationCount');
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<HistorySyncCursorRow> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('profile_id')) {
      context.handle(_profileIdMeta, profileId.isAcceptableOrUnknown(data['profile_id']!, _profileIdMeta));
    ...
    if (data.containsKey('forward_cursor_at')) {
      context.handle(
        ...
        forwardCursorAt.isAcceptableOrUnknown(data['forward_cursor_at']!, _forwardCursorAtMeta),
      );
    }
    if (data.containsKey('forward_last_row_id')) {
      context.handle(
        _forwardLastRowIdMeta,
        forwardLastRowId.isAcceptableOrUnknown(data['forward_last_row_id']!, _forwardLastRowIdMeta),
      );
    }
    if (data.containsKey('backfill_before_day')) {
      context.handle(
        _backfillBeforeDayMeta,
        backfillBeforeDay.isAcceptableOrUnknown(data['backfill_before_day']!, _backfillBeforeDayMeta),
      );
    }
    if (data.containsKey('backfill_offset')) {
      context.handle(
        _backfillOffsetMeta,
        backfillOffset.isAcceptableOrUnknown(data['backfill_offset']!, _backfillOffsetMeta),
      );
    }
    if (data.containsKey('backfill_cursor_at')) {
      context.handle(
        _backfillCursorAtMeta,
        backfillCursorAt.isAcceptableOrUnknown(data['backfill_cursor_at']!, _backfillCursorAtMeta),
      );
    }
    if (data.containsKey('backfill_state')) {
      context.handle(
        _backfillStateMeta,
        backfillState.isAcceptableOrUnknown(data['backfill_state']!, _backfillStateMeta),
      );
    }
    if (data.containsKey('forward_truncation_count')) {
      context.handle(
        _forwardTruncationCountMeta,
        forwardTruncationCount.isAcceptableOrUnknown(data['forward_truncation_count']!, _forwardTruncationCountMeta),
      );
    }
  ...
  HistorySyncCursorRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return HistorySyncCursorRow(
      ...
      backfillOffset: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}backfill_offset'])!,
      backfillCursorAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}backfill_cursor_at'],
      ),
      backfillState: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}backfill_state'])!,
      forwardTruncationCount: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}forward_truncation_count'],
      )!,
      lastSyncAt: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}last_sync_at'])!,
    );
  }
...
class HistorySyncCursorRow extends DataClass implements Insertable<HistorySyncCursorRow> {
  final String profileId;
  final String serverId;
  ...
  HistorySyncCursorsCompanion toCompanion(bool nullToAbsent) {
    return HistorySyncCursorsCompanion(
      ...
      forwardLastRowId: forwardLastRowId == null && nullToAbsent ? const Value.absent() : Value(forwardLastRowId),
      backfillBeforeDay: backfillBeforeDay == null && nullToAbsent ? const Value.absent() : Value(backfillBeforeDay),
      backfillOffset: Value(backfillOffset),
      backfillCursorAt: backfillCursorAt == null && nullToAbsent ? const Value.absent() : Value(backfillCursorAt),
  ...
  factory HistorySyncCursorRow.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return HistorySyncCursorRow(
      profileId: serializer.fromJson<String>(json['profileId']),
      serverId: serializer.fromJson<String>(json['serverId']),
      ...
      backfillBeforeDay: serializer.fromJson<String?>(json['backfillBeforeDay']),
      ...
      forwardTruncationCount: serializer.fromJson<int>(json['forwardTruncationCount']),
  ...
  HistorySyncCursorRow copyWith({
    ...
    forwardLastRowId: forwardLastRowId.present ? forwardLastRowId.value : this.forwardLastRowId,
    backfillBeforeDay: backfillBeforeDay.present ? backfillBeforeDay.value : this.backfillBeforeDay,
    backfillOffset: backfillOffset ?? this.backfillOffset,
    backfillCursorAt: backfillCursorAt.present ? backfillCursorAt.value : this.backfillCursorAt,
  ...
  HistorySyncCursorRow copyWithCompanion(HistorySyncCursorsCompanion data) {
    return HistorySyncCursorRow(
      ...
      serverId: data.serverId.present ? data.serverId.value : this.serverId,
      source: data.source.present ? data.source.value : this.source,
      forwardCursorAt: data.forwardCursorAt.present ? data.forwardCursorAt.value : this.forwardCursorAt,
      forwardLastRowId: data.forwardLastRowId.present ? data.forwardLastRowId.value : this.forwardLastRowId,
      backfillBeforeDay: data.backfillBeforeDay.present ? data.backfillBeforeDay.value : this.backfillBeforeDay,
      backfillOffset: data.backfillOffset.present ? data.backfillOffset.value : this.backfillOffset,
      backfillCursorAt: data.backfillCursorAt.present ? data.backfillCursorAt.value : this.backfillCursorAt,
      backfillState: data.backfillState.present ? data.backfillState.value : this.backfillState,
...
class HistorySyncCursorsCompanion extends UpdateCompanion<HistorySyncCursorRow> {
  final Value<String> profileId;
  final Value<String> serverId;
  final Value<String> source;
  ...
  static Insertable<HistorySyncCursorRow> custom({
    ...
    return RawValuesInsertable({
      ...
      if (forwardTruncationCount != null) 'forward_truncation_count': forwardTruncationCount,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (forwardTruncationCount.present) {
      map['forward_truncation_count'] = Variable<int>(forwardTruncationCount.value);
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $MediaInteractionsTable mediaInteractions = $MediaInteractionsTable(this);
  late final $AffinitySnapshotsTable affinitySnapshots = $AffinitySnapshotsTable(this);
  late final $HistorySyncCursorsTable historySyncCursors = $HistorySyncCursorsTable(this);
...
class $$DownloadedMediaTableFilterComposer extends Composer<_$AppDatabase, $DownloadedMediaTable> {
  ...
  ColumnFilters<bool> get autoPaused =>
      $composableBuilder(column: $table.autoPaused, builder: (column) => ColumnFilters(column));
...
class $$DownloadedMediaTableOrderingComposer extends Composer<_$AppDatabase, $DownloadedMediaTable> {
  ...
  ColumnOrderings<bool> get autoPaused =>
      $composableBuilder(column: $table.autoPaused, builder: (column) => ColumnOrderings(column));
...
class $$DownloadedMediaTableAnnotationComposer extends Composer<_$AppDatabase, $DownloadedMediaTable> {
  ...
  GeneratedColumn<bool> get autoPaused => $composableBuilder(column: $table.autoPaused, builder: (column) => column);
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> bgTaskId = const Value.absent(),
                Value<bool> autoPaused = const Value.absent(),
...
class $$MediaInteractionsTableFilterComposer extends Composer<_$AppDatabase, $MediaInteractionsTable> {
  ...
  ColumnFilters<String> get mediaKind =>
      $composableBuilder(column: $table.mediaKind, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get eventType =>
      $composableBuilder(column: $table.eventType, builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get eventWeight =>
      $composableBuilder(column: $table.eventWeight, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get occurredAt =>
      $composableBuilder(column: $table.occurredAt, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get genresJson =>
      $composableBuilder(column: $table.genresJson, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get actorsJson =>
      $composableBuilder(column: $table.actorsJson, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get directorsJson =>
      $composableBuilder(column: $table.directorsJson, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get moodsJson =>
      $composableBuilder(column: $table.moodsJson, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get studio =>
      $composableBuilder(column: $table.studio, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get year => $composableBuilder(column: $table.year, builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get communityRating =>
      $composableBuilder(column: $table.communityRating, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get seriesKey =>
      $composableBuilder(column: $table.seriesKey, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get source =>
      $composableBuilder(column: $table.source, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get sourceEventId =>
      $composableBuilder(column: $table.sourceEventId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get sourceServerId =>
      $composableBuilder(column: $table.sourceServerId, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get completionPercent =>
      $composableBuilder(column: $table.completionPercent, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get playSeconds =>
      $composableBuilder(column: $table.playSeconds, builder: (column) => ColumnFilters(column));
}

class $$MediaInteractionsTableOrderingComposer extends Composer<_$AppDatabase, $MediaInteractionsTable> {
  ...
  ColumnOrderings<String> get mediaKind =>
      $composableBuilder(column: $table.mediaKind, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get eventType =>
      $composableBuilder(column: $table.eventType, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<double> get eventWeight =>
      $composableBuilder(column: $table.eventWeight, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get occurredAt =>
      $composableBuilder(column: $table.occurredAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get genresJson =>
      $composableBuilder(column: $table.genresJson, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get actorsJson =>
      $composableBuilder(column: $table.actorsJson, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get directorsJson =>
      $composableBuilder(column: $table.directorsJson, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get moodsJson =>
      $composableBuilder(column: $table.moodsJson, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get studio =>
      $composableBuilder(column: $table.studio, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get year =>
      $composableBuilder(column: $table.year, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<double> get communityRating =>
      $composableBuilder(column: $table.communityRating, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get seriesKey =>
      $composableBuilder(column: $table.seriesKey, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get source =>
      $composableBuilder(column: $table.source, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get sourceEventId =>
      $composableBuilder(column: $table.sourceEventId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get sourceServerId =>
      $composableBuilder(column: $table.sourceServerId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get completionPercent =>
      $composableBuilder(column: $table.completionPercent, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get playSeconds =>
      $composableBuilder(column: $table.playSeconds, builder: (column) => ColumnOrderings(column));
}

class $$MediaInteractionsTableAnnotationComposer extends Composer<_$AppDatabase, $MediaInteractionsTable> {
  ...
  GeneratedColumn<String> get mediaKind => $composableBuilder(column: $table.mediaKind, builder: (column) => column);

  GeneratedColumn<String> get eventType => $composableBuilder(column: $table.eventType, builder: (column) => column);

  GeneratedColumn<double> get eventWeight =>
      $composableBuilder(column: $table.eventWeight, builder: (column) => column);

  GeneratedColumn<int> get occurredAt => $composableBuilder(column: $table.occurredAt, builder: (column) => column);

  GeneratedColumn<String> get genresJson => $composableBuilder(column: $table.genresJson, builder: (column) => column);

  GeneratedColumn<String> get actorsJson => $composableBuilder(column: $table.actorsJson, builder: (column) => column);

  GeneratedColumn<String> get directorsJson =>
      $composableBuilder(column: $table.directorsJson, builder: (column) => column);

  GeneratedColumn<String> get moodsJson => $composableBuilder(column: $table.moodsJson, builder: (column) => column);

  GeneratedColumn<String> get studio => $composableBuilder(column: $table.studio, builder: (column) => column);

  GeneratedColumn<int> get year => $composableBuilder(column: $table.year, builder: (column) => column);

  GeneratedColumn<double> get communityRating =>
      $composableBuilder(column: $table.communityRating, builder: (column) => column);

  GeneratedColumn<String> get seriesKey => $composableBuilder(column: $table.seriesKey, builder: (column) => column);

  GeneratedColumn<String> get source => $composableBuilder(column: $table.source, builder: (column) => column);

  GeneratedColumn<String> get sourceEventId =>
      $composableBuilder(column: $table.sourceEventId, builder: (column) => column);

  GeneratedColumn<String> get sourceServerId =>
      $composableBuilder(column: $table.sourceServerId, builder: (column) => column);

  GeneratedColumn<int> get completionPercent =>
      $composableBuilder(column: $table.completionPercent, builder: (column) => column);

  GeneratedColumn<int> get playSeconds => $composableBuilder(column: $table.playSeconds, builder: (column) => column);
}
...
class $$MediaInteractionsTableTableManager
    extends
        RootTableManager<
          ...
          (MediaInteractionRow, BaseReferences<_$AppDatabase, $MediaInteractionsTable, MediaInteractionRow>),
          MediaInteractionRow,
          PrefetchHooks Function()
        > {
  $$MediaInteractionsTableTableManager(_$AppDatabase db, $MediaInteractionsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$MediaInteractionsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$MediaInteractionsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$MediaInteractionsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> profileId = const Value.absent(),
...
class $$AffinitySnapshotsTableFilterComposer extends Composer<_$AppDatabase, $AffinitySnapshotsTable> {
  ...
  ColumnFilters<String> get vectorJson =>
      $composableBuilder(column: $table.vectorJson, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get eventCount =>
      $composableBuilder(column: $table.eventCount, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get computedAt =>
      $composableBuilder(column: $table.computedAt, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get enabledKey =>
      $composableBuilder(column: $table.enabledKey, builder: (column) => ColumnFilters(column));
}

class $$AffinitySnapshotsTableOrderingComposer extends Composer<_$AppDatabase, $AffinitySnapshotsTable> {
  ...
  ColumnOrderings<String> get vectorJson =>
      $composableBuilder(column: $table.vectorJson, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get eventCount =>
      $composableBuilder(column: $table.eventCount, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get computedAt =>
      $composableBuilder(column: $table.computedAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get enabledKey =>
      $composableBuilder(column: $table.enabledKey, builder: (column) => ColumnOrderings(column));
}

class $$AffinitySnapshotsTableAnnotationComposer extends Composer<_$AppDatabase, $AffinitySnapshotsTable> {
  ...
  GeneratedColumn<String> get vectorJson => $composableBuilder(column: $table.vectorJson, builder: (column) => column);

  GeneratedColumn<int> get eventCount => $composableBuilder(column: $table.eventCount, builder: (column) => column);

  GeneratedColumn<int> get computedAt => $composableBuilder(column: $table.computedAt, builder: (column) => column);

  GeneratedColumn<String> get enabledKey => $composableBuilder(column: $table.enabledKey, builder: (column) => column);
}
...
class $$AffinitySnapshotsTableTableManager
    extends
        RootTableManager<
          ...
          (AffinitySnapshotRow, BaseReferences<_$AppDatabase, $AffinitySnapshotsTable, AffinitySnapshotRow>),
          AffinitySnapshotRow,
          PrefetchHooks Function()
        > {
  $$AffinitySnapshotsTableTableManager(_$AppDatabase db, $AffinitySnapshotsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$AffinitySnapshotsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$AffinitySnapshotsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$AffinitySnapshotsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> profileId = const Value.absent(),
...
class $$HistorySyncCursorsTableFilterComposer extends Composer<_$AppDatabase, $HistorySyncCursorsTable> {
  ...
  ColumnFilters<int> get forwardCursorAt =>
      $composableBuilder(column: $table.forwardCursorAt, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get forwardLastRowId =>
      $composableBuilder(column: $table.forwardLastRowId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get backfillBeforeDay =>
      $composableBuilder(column: $table.backfillBeforeDay, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get backfillOffset =>
      $composableBuilder(column: $table.backfillOffset, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get backfillCursorAt =>
      $composableBuilder(column: $table.backfillCursorAt, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get backfillState =>
      $composableBuilder(column: $table.backfillState, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get forwardTruncationCount =>
      $composableBuilder(column: $table.forwardTruncationCount, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get lastSyncAt =>
      $composableBuilder(column: $table.lastSyncAt, builder: (column) => ColumnFilters(column));
}

class $$HistorySyncCursorsTableOrderingComposer extends Composer<_$AppDatabase, $HistorySyncCursorsTable> {
  ...
  ColumnOrderings<int> get forwardCursorAt =>
      $composableBuilder(column: $table.forwardCursorAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get forwardLastRowId =>
      $composableBuilder(column: $table.forwardLastRowId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get backfillBeforeDay =>
      $composableBuilder(column: $table.backfillBeforeDay, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get backfillOffset =>
      $composableBuilder(column: $table.backfillOffset, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get backfillCursorAt =>
      $composableBuilder(column: $table.backfillCursorAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get backfillState =>
      $composableBuilder(column: $table.backfillState, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get forwardTruncationCount =>
      $composableBuilder(column: $table.forwardTruncationCount, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get lastSyncAt =>
      $composableBuilder(column: $table.lastSyncAt, builder: (column) => ColumnOrderings(column));
}

class $$HistorySyncCursorsTableAnnotationComposer extends Composer<_$AppDatabase, $HistorySyncCursorsTable> {
  ...
  GeneratedColumn<int> get forwardCursorAt =>
      $composableBuilder(column: $table.forwardCursorAt, builder: (column) => column);

  GeneratedColumn<int> get forwardLastRowId =>
      $composableBuilder(column: $table.forwardLastRowId, builder: (column) => column);

  GeneratedColumn<String> get backfillBeforeDay =>
      $composableBuilder(column: $table.backfillBeforeDay, builder: (column) => column);

  GeneratedColumn<int> get backfillOffset =>
      $composableBuilder(column: $table.backfillOffset, builder: (column) => column);

  GeneratedColumn<int> get backfillCursorAt =>
      $composableBuilder(column: $table.backfillCursorAt, builder: (column) => column);

  GeneratedColumn<String> get backfillState =>
      $composableBuilder(column: $table.backfillState, builder: (column) => column);

  GeneratedColumn<int> get forwardTruncationCount =>
      $composableBuilder(column: $table.forwardTruncationCount, builder: (column) => column);

  GeneratedColumn<int> get lastSyncAt => $composableBuilder(column: $table.lastSyncAt, builder: (column) => column);
}
...
class $$HistorySyncCursorsTableTableManager
    extends
        RootTableManager<
          ...
          (HistorySyncCursorRow, BaseReferences<_$AppDatabase, $HistorySyncCursorsTable, HistorySyncCursorRow>),
          HistorySyncCursorRow,
          PrefetchHooks Function()
        > {
  $$HistorySyncCursorsTableTableManager(_$AppDatabase db, $HistorySyncCursorsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$HistorySyncCursorsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$HistorySyncCursorsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$HistorySyncCursorsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> profileId = const Value.absent(),
                Value<String> serverId = const Value.absent(),
