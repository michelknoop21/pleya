...
class $DownloadedMediaTable extends DownloadedMedia
  ...
  static const VerificationMeta _autoPausedMeta = const VerificationMeta(
    'autoPaused',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('auto_paused')) {
      context.handle(
        _autoPausedMeta,
        autoPaused.isAcceptableOrUnknown(data['auto_paused']!, _autoPausedMeta),
      );
    }
  ...
  DownloadedMediaItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DownloadedMediaItem(
      ...
      autoPaused: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}auto_paused'],
      )!,
...
class DownloadedMediaItem extends DataClass
  ...
  DownloadedMediaItem copyWithCompanion(DownloadedMediaCompanion data) {
    return DownloadedMediaItem(
      ...
      autoPaused: data.autoPaused.present
          ? data.autoPaused.value
          : this.autoPaused,
...
class $$DownloadedMediaTableFilterComposer
  ...
  ColumnFilters<bool> get autoPaused => $composableBuilder(
    column: $table.autoPaused,
    builder: (column) => ColumnFilters(column),
  );
...
class $$DownloadedMediaTableOrderingComposer
  ...
  ColumnOrderings<bool> get autoPaused => $composableBuilder(
    column: $table.autoPaused,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$DownloadedMediaTableAnnotationComposer
  ...
  GeneratedColumn<bool> get autoPaused => $composableBuilder(
    column: $table.autoPaused,
    builder: (column) => column,
  );
