...
/// Hoofdstuk 14.3's one hard rule, field by field: "Ontbrekende metadata wordt
/// weggelaten. Geen rijen vol 'Onbekend'." (F13, F14.)
...
TvSourceRowDescriptor _describe(UnifiedMediaSource source, {bool showBackend = false}) =>
...
void main() {
  group('quality line', () {
    ...
    test('F13: a source with no media versions has no quality line at all', () {
  ...
  group('status label ranking', () {
    ...
    test('an unusable row says why, and outranks every other marking', () {
      ...
      // Hoofdstuk 14.7 requires these two to differ.
