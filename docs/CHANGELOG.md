...
DEC-129 en DEC-135 tot en met DEC-138 verplaatst. De mergebasis staat in `0b9699ec`; 26 van 29 onafhankelijke reviewbevindingen
...
_Hersteld uit `d4af0122`: deze drie entries vielen weg in merge `0b9699ec`, die dit bestand van één ouder overnam. De DEC-nummers erin zijn die van vóór de hernummering van 20 september; de tabel onderaan `docs/DECISIONS.md` geeft de huidige nummers._
