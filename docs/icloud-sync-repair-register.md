...
| A3 | sleutelaantal gemeten | UNIT VERIFIED | taak 8 | `test/services/preferences/kvs_footprint_test.dart`: 655 van 1024 sleutels bij 4 profielen, plus 216 bevroren v1-sleutels = 871. Niet meegeteld: tombstones van verdwenen bibliotheken (drie sleutels per bibliotheek per profiel), dus er is ruimte voor ongeveer 50 verdwenen bibliotheken over alle profielen samen |
