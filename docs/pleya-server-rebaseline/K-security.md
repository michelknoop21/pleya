...
| 2 | Lid of beperkt bereikt een beheerresource | 404, nooit 403; tabelgedreven test met drie rollen per route (uitbreiding van `authorize_test.go`, DEC-072) | per nieuwe route: owner 2xx, member 404, restricted 404, en de body is byte-gelijk aan die van een niet-bestaand id | S1, S2, S3, S5, S6 |
...
Een slice met een nieuw endpoint sluit niet zonder de rij in de autorisatiematrix (DEC-072) en de
