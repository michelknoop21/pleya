...
| --- | --- | --- | --- | --- | --- | --- |
| X1 | E-bookbibliotheek: scannen, catalogiseren, cover en EPUB ontsluiten | eigen Pleya-functionaliteit | PS-14 | `In roadmap` | [DEC-093](DECISIONS.md) | PS-2, PS-9 |
| X2 | E-books lezen in de mobiele app, met leespositie tussen toestellen | eigen Pleya-functionaliteit | PS-15 | `In roadmap` | [DEC-093](DECISIONS.md) | PS-14 |
| X3 | Offline e-books en gesynchroniseerde bladwijzers | eigen Pleya-functionaliteit | PS-16 | `Niet ontworpen` | [DEC-093](DECISIONS.md) | PS-15 |
