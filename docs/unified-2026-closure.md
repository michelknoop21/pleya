...
| 5 | I6 film- en seriedetail (06, 07) | gedeelde data, identity en activation, eigen mobiele widget; volledige synopsis; seizoenstaat blijft bewaard | widgettests en ios-sim Verify. **`CODE CLOSED · VERIFY/SIM CLOSED (met bevinding)`**: op `feat/i6-ios-film-serie-detail` (`7d5bced3`), 4 commits voor op `main`, nog niet gemerged. Widgettests groen, `ios.detail.northstar.yaml`/`ios.detail-episodes.northstar.yaml` beide PASS. Eén echte bevinding (geen fixture-artefact): bij een serie toont de build naast "Afspelen" ook een losse volle-breedte "Downloaden"-knop, de mockup heeft bij een serie alleen een download-icoon per episoderij (`mobile_detail_view.dart:59-61`), niet gefixt |
