...
| 4 | I5 bronkeuze (08) en contextmenu (09) | `UnifiedActivationCoordinator` beslist; sheets via de bestaande `OverlaySheetHost`; markeer-bekeken met groepssemantiek | geen tweede sheet-stack; contracttests. **`CODE CLOSED · VERIFY/SIM OPEN`**: gemerged in `main` via `025b400b` (contextmenu) en `68f98bbb` (bronkeuze/Wijzigen/failure-re-entry), widgettests groen, geen ios-sim Verify-run tegen mockup 08/09 vastgelegd |
