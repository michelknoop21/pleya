...
landde de migratie en de `managed`-kolom, S2.2 opende protocolvenster 2 met [DEC-136](DECISIONS.md)
...
[DEC-133](DECISIONS.md), werd op één punt gecorrigeerd door
[DEC-134](DECISIONS.md) (venster 1 voegt twee foutdomeinen toe en niet één) en is met S1.6 gesloten
met [DEC-135](DECISIONS.md); `openapi.yaml` is daarmee weer bevroren. PS-14 blijft gesloten tot
...
S1, met alle zeventien rijen erin ([DEC-133](DECISIONS.md), [DEC-134](DECISIONS.md),
[DEC-135](DECISIONS.md)). Er staat er nu geen open. De volledige stand staat in hoofdstuk 4.
