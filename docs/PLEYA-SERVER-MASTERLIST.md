...
Laatst bijgewerkt: 2026-09-07 (S2.3, `GET /storage/roots` en de recheck). Bron voor de scope:
...
landde de migratie en de `managed`-kolom, S2.2 opende protocolvenster 2 met [DEC-113](DECISIONS.md)
...
[DEC-110](DECISIONS.md), werd op één punt gecorrigeerd door
