...
Laatst bijgewerkt: 2026-09-05 (S1.4 gesloten). Bron voor de scope: `docs/pleya-server-rebaseline/`
...
Per taak, en dat is de maat die telt: **148 taken, 14 gereed, 2 bezig, 132 open.** S0 is dicht met
acht van acht. S1 staat op vier van acht en is de lopende slice; de twee andere gereed-vinkjes zijn
...
| --- | --- | --- | --- | --- |
| 1, loopt | S1, S2 | 10 | beheer-backend compleet: instellingen, diagnostiek, tokens, audit, bibliotheken, opslag, scans | niets |
...
van de 134 resterende. Hij blokkeert alleen S15.
...
P8 (Plex-off gate). Van de acht protocolvensters is er één open: venster 1, bij S1, met tien van
