...
Laatst bijgewerkt: 2026-09-05 (S1.8 gesloten). Bron voor de scope: `docs/pleya-server-rebaseline/`
...
Per taak, en dat is de maat die telt: **148 taken, 16 gereed, 2 bezig, 130 open.** S0 is dicht met
acht van acht. S1 staat op zes van acht en is de lopende slice; de twee andere gereed-vinkjes zijn
...
loopt**, en S1 is de lopende slice: S1.7 (de drie-rollen-ronde) staat nog open, en S1.6 sluit het
venster met de laatste vier rijen (1, 10, 15 en 16). Rij 16 is met S1.8 geland, dus wat S1.6 nog
moet doen zijn rij 1, 10 en 15 plus het sluiten zelf. Het protocolvenster voor S1 is geopend met
...
| --- | --- | --- | --- | --- |
| 1, loopt | S1, S2 | 8 | beheer-backend compleet: instellingen, diagnostiek, tokens, audit, bibliotheken, opslag, scans | niets |
...
van de 132 resterende. Hij blokkeert alleen S15.
