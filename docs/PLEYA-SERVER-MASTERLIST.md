...
Laatst bijgewerkt: 2026-09-20 (integratie- en reviewherstel). De completionbasis is vastgelegd in
mergecommit `0b9699ec` en 26 van de 29 reviewpunten in `3734e399`; de lokale CI-check was groen.
De hieronder getelde
148 taken zijn nog de laatst volledig gereconcilieerde productbaseline van 7 september; gebruik ze
nog niet als actuele telling. De resterende herstelstand is twee bewust RED en één open, gevolgd door
gedragssuites en overige brede gates, release-/authority-afronding en het
terugbrengen van S2.4/loudness. Zie
...
Per taak, en dat is de maat die telt: **148 taken, 21 gereed, 0 bezig, 127 open.** S0 en S1 zijn
...
landde de migratie en de `managed`-kolom, S2.2 opende protocolvenster 2 met [DEC-133](DECISIONS.md)
...
[DEC-130](DECISIONS.md), werd op één punt gecorrigeerd door
[DEC-131](DECISIONS.md) (venster 1 voegt twee foutdomeinen toe en niet één) en is met S1.6 gesloten
met [DEC-132](DECISIONS.md); `openapi.yaml` is daarmee weer bevroren. PS-14 blijft gesloten tot
...
S1, met alle zeventien rijen erin ([DEC-130](DECISIONS.md), [DEC-131](DECISIONS.md),
[DEC-132](DECISIONS.md)). Er staat er nu geen open. De volledige stand staat in hoofdstuk 4.
...
| S0.8 | Vrijgavebesluit PS-14 en PS-11A vastgelegd | `[x]` | [DEC-129](DECISIONS.md#dec-129-ps-11a-is-de-eerstvolgende-fase-ps-14-blijft-gesloten-en-loopt-er-niet-naast): PS-11A vrijgegeven zodra de blokkerende S0-poorten groen zijn, PS-14 blijft gesloten en mag er niet naast lopen | 2026-09-04 |
...
| S2.4 | Scans en jobs over HTTP, annuleren, retry, backoff op `probe_attempts` | `[~]` | Migratie 0010 geland; endpoints en annulering volgen in dit plan. | 2026-09-24 |
