...
Laatst bijgewerkt: 2026-09-05 (S1.5 gesloten). Bron voor de scope: `docs/pleya-server-rebaseline/`
...
Per taak, en dat is de maat die telt: **148 taken, 15 gereed, 2 bezig, 131 open.** S0 is dicht met
acht van acht. S1 staat op vijf van acht en is de lopende slice; de twee andere gereed-vinkjes zijn
...
loopt**, en S1 is de lopende slice: S1.8 (HttpOnly-refreshcookie) en S1.7 (de drie-rollen-ronde) staan
nog open, en S1.6 sluit het venster. Het protocolvenster voor S1 is geopend met
...
| --- | --- | --- | --- | --- |
| 1, loopt | S1, S2 | 9 | beheer-backend compleet: instellingen, diagnostiek, tokens, audit, bibliotheken, opslag, scans | niets |
...
van de 133 resterende. Hij blokkeert alleen S15.
...
P8 (Plex-off gate). Van de acht protocolvensters is er één open: venster 1, bij S1, met dertien van
