...
| PLR10 | De slaaptimer in het spelerpaneel toont "5minuten" en "1uur, 30minuten", zonder spatie; mockup 33 schrijft "15 minuten" | OPEN | n.v.t. | Gezien in de TV7-run van `tvos.player.panel` (23 september). Niet gerepareerd in TV7, dat bewijs levert en geen herontwerp. |
