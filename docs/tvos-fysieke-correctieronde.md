...
| HOME-REFRESH | Home toont geen nieuw toegevoegde films of series zolang de app open blijft (melding 24 sep 2026, vooral Apple TV). | CODE+SIM DONE · HARDWARE OPEN | `80d57172`, `4c3d7d12`, `9d7ac906`, `8e98f4a2`, `a85183af`, `65bfaf35` | Oorzaak: `DiscoverProvider` laadde hubs alleen bij een volledige `load()`; terugkeer, resume en watch-events verversten alleen Verder kijken, en de lokale map hield zijn scan de hele sessie. Nu `refreshIfStale` (2 min bij terugkeer/resume, timer van 5 min zolang Home actief is), stil en zonder focusverlies. `tvos.home.recently-added-refresh` PASS in `tvos-home-recently-added-refresh-1790287881552`. Hardware: laat de Apple TV op Home staan, voeg een film toe en kijk of hij binnen vijf minuten verschijnt. |
