...
| NLX3 | Goedgekeurd Netflix-redesign vervolg: Verbinding toevoegen en daarna de resterende vensters tegen actuele UI beoordelen en per scherm alle bestaande routes en acties behouden. Simulator bewijst presentatie/navigatie; aanmelden en Siri Remote-touch vragen aparte live-/hardwarecontrole. | OPEN | n.v.t. | Na NLX2, volgens dezelfde functiepariteit. |
