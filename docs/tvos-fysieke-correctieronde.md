...
| STR1 | Hardcoded "Video" in `tv_info_panel.dart:265`; nu `videoControls.tvPanel.video` (PLR2) | FIXED, Mac-run open | SHA volgt |
| STR2 | Hardcoded "(Forced)" in `track_label_builder.dart:203-205`; nu `videoControls.forcedTrackSuffix` (PLR2) | FIXED, Mac-run open | SHA volgt |
...
| PNL1 | Infopaneel gooit de secundaire spoorlabels van `TrackLabelBuilder` weg; nu de tweede regel van elke spoorrij (PLR2) | FIXED, Mac-run open | SHA volgt |
