...
| UX23-HERO | Meer hero-items zonder Home opnieuw te ontwerpen. | APPROVED, uitvoering open | n.v.t. | Code: maximum acht, ophalen twaalf, uitsluitend recente films. Goedgekeurd: maximaal twaalf unieke geschikte films; eerst RED→GREEN en actuele fixture/echt-profielpool meten. Geen wijziging van DEC-067 buiten de bovengrens. |
| UX23-PREF | Gedeelde instellingen-subpagina’s wijken visueel af van TV-overzichten. | APPROVED DIRECTION, uitvoering open | n.v.t. | Actueel Uiterlijk-beeld in `tvos-ux23-settings-depth-1790184222009/01-appearance` bevestigt andere marges, grote segmentblokken en focuspresentatie. Richtingen 02/03 en verbindingspicker 04 zijn goedgekeurd, maar volgen na tranche 1 als afzonderlijk pakket. De runfaal was een onjuiste aanname over een aparte themapicker, geen bewezen Back-bug. |
...
| UX23-ROWS | Home-indeling toont twee rijen met dezelfde titel Recent toegevoegd en dezelfde servernaam Zolder; acties staan dicht bij de rechterrand. | OPEN, GUI-ambiguïteit | n.v.t. | Simulatorbeeld `tvos-ux23-settings-followup-1790184518723/screenshots/01-home-layout.png`. Geen claim van dubbele catalogusdata. Voorstel: herkenbare mediatype/bibliotheekcontext waar beschikbaar en TV-safe-insets; bestaande rij-ID’s en functies behouden. Back herstelt hier correct de Home-indeling-tegel. |
