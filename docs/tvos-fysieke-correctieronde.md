...
| CAT7 | Op zowel Alle films als Alle series valt de focusring om een kaart aan de rechterkant buiten beeld: gemeld door Michel op 6 september met een fysieke foto van "House" in Alle series, ring zichtbaar afgesneden aan de rechterrand van het scherm. Nog niet gereproduceerd of onderzocht; root cause en eigenaar (vermoedelijk `TvUnifiedMediaGrid`/`tv_catalog_grid`'s overscan- of veilige-marge-afhandeling) staan nog open | OPEN | n.v.t. |
| CAT8 | Jaartal en seizoensregel onder een kaart staan te dicht tegen de onderrand van het scherm, maar alleen wanneer je eerst naar de tweede rij navigeert en dan terug naar de eerste (Michel, 6 september, met foto). Dus geen statische marge-fout maar iets dat met een scroll- of layoutherberekening bij het terugkeren naar rij 1 samenhangt. Nog niet gereproduceerd of onderzocht | OPEN | n.v.t. |
