...
| TOK3 | De segmented tabstijl houdt op TV zijn eigen accentrul (seizoentabs, Seerr-aanvraagfilters) | DEELS GESLOTEN, seizoentabs open | DEC-108 | De Seerr-helft is weg: de statusfilter van Alle aanvragen was de `SegmentedTabGroup` die op TV als enige die accentrul droeg, en is bij de bouw van mockup 35 een subview van de CAT5-rail geworden, met de aantallen die Seerr zelf al rapporteert ernaast. De seizoentabs dragen hem nog wel en houden deze rij open |
