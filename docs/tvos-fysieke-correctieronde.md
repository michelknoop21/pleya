...
| DPR1 | Apple TV 4K geeft 4K uit, maar de UI oogt als opgeschaalde 1080p. De engine-fork zet de DPR uit `windowScene.screen.scale`; niemand heeft op hardware gemeten of die 2,0 is. | HARDWARE ONLY | n.v.t. | Eén logregel na het eerste frame met DPR en fysieke resolutie. Uitlezen via `ice.pleya.app/logs/<nummer>` na de volgende build. Geen wijziging aan de schaal of de engine. |
