...
| CAT20 | Alle films toont niet alle servers: G-Plexflix verloor bij de koude start de endpoint-race (`bound 1/2`, kwam pas om 23:06:27.157 binnen met `merged 4 libraries`, ná de eerste opvraging door Home en de Films-landing). Log `ijqxp` (build 280): de catalogusscreen (23:07:36-23:08:25) vroeg alleen secties op bij 192-x-x-135. Vermoedelijke eigenaar: het opgeslagen, al ingekorte bronfilter in `tv_unified_catalog_screen.dart:319-329` of `source_cursor.dart:62-86`. Volgens Michel op 15 september al opgelost. TV2-preflight (18 september, `330a51e4`): `git log --oneline --since=2026-09-13 -- lib/screens/tv/tv_unified_catalog_screen.dart lib/services/unified_catalog/ lib/providers/unified_catalog_provider.dart` toont twee commits sinds 13 september (`ee2901b5` HERO7-focusherstel, `b7f57fef` CAT19 LEFT-navigatie), maar geen van beide raakt `_restorePreferences`, `withKnownSources` of `source_cursor.dart`; `_restorePreferences` (`tv_unified_catalog_screen.dart:310-329`) past `withKnownSources` nog steeds toe en schrijft het resultaat terug met `UnifiedCatalogQueryStore.write`, ongewijzigd. De "opgelost"-melding is dus niet door een commit op de vermoedelijke eigenaar gedekt | IN PROGRESS, geen commit onder de "opgelost"-melding | n.v.t. |
