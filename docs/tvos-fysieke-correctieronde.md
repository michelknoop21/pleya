...
| VIS-0925-E | Hero in Light: de scrim is een witte waas over 60% van het beeld; CTA-ring in `tk.text` op 4 pt afstand geeft een zwart-witte dubbele rand; titel, CTA en eerste railtegel staan op drie x-posities. | FIXED, Verify-sim PASS, hardware open | `22e94b0e`, `b7a743e2`, `a5bb92f7`, `3cac0ebe` | Synopsis 4,5:1 over de hele kolom in `test/widgets/tv/tv_hero_scrim_light_test.dart`, x-lijn in `tv_content_feed_test.dart`. De eerste versie zette de hero op 83,34; na de review weer op 75,48 (hieronder). Review-fixronde (besluit Michel D1, D3): hero-titel, CTA-vulling en railkop terug op de paginarand (75,48), alleen de tegelartwork springt een ringband in; CTA-ring met dezelfde vrije band als de categorierail; gedimde hero houdt in Light de +0,08. Scenario `tvos.home.hero-cta-focus`. |
