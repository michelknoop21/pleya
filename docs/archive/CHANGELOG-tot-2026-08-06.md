# Changelog, 3 juli tot en met 6 augustus 2026

Gearchiveerd op 19 augustus 2026 omdat `docs/CHANGELOG.md` boven de leesbare lengte uit liep. De
entries zijn ongewijzigd overgenomen; nieuwste bovenaan, net als in het hoofdbestand. Het vervolg
staat in [docs/CHANGELOG.md](../CHANGELOG.md), vanaf 10 augustus 2026.
